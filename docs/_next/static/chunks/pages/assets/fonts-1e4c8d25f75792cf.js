  ...
  [2912],
  {
    ...
    4168: (e, t, a) => {
      ...
      let F = [
          ...
          { id: 'lato', name: 'Lato', className: u().className },
      ...
      let c = () => {
        ...
        x = (e) => {
          let { emoji: t = '', title: a = '', links: r = [], query: l = '', setState: n, disabledSearch: i = !1 } = e,
            { darkMode: d = !1, toggleDarkMode: m } = c();
          return (0, s.jsx)('nav', {
          ...
          let {
            ...
            { emoji: p = c, description: h = m } =
              ...
              (t = b.find((e) => {
                ...
                ? t
                : { emoji: c, description: m };
          return (0, s.jsxs)(s.Fragment, {
            children: [
              (0, s.jsxs)(f(), {
                children: [
                  (0, s.jsxs)('title', { children: [p, ' ', d] }),
                  (0, s.jsx)('meta', { name: 'description', content: h || m }),
                ],
              }),
              (0, s.jsxs)('div', {
                  ...
                  (0, s.jsxs)('div', {
                    ...
                    children: [
                      (0, s.jsxs)('main', {
                        ...
                        children: [(0, s.jsx)(n, { emoji: p || c, title: d, description: h || m }), u],
                      }),
                      (0, s.jsx)(r, { title: d }),
                    ],
                  }),
