(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [1377],
  {
    ...
    3286: (e, t, a) => {
      ...
      let l = (e) => {
        ...
        s = (e) => {
          let { title: t = '', subtitle: a = '', description: l = '', features: s = [] } = e;
      ...
      var i = a(1668),
        ...
        x = a.n(o);
      let u = (e) => {
          let { title: t = '', links: a = [], query: l = '', setState: s, disabledSearch: n = !1 } = e,
                          ...
                          children: (0, r.jsxs)('div', {
                            ...
                            children: [
                              ...
                              (0, r.jsxs)('div', {
                                ...
                                children: [
                                  a.map((e) => {
                                    let { id: t = '', href: a = '', emoji: l = '', text: s = '' } = e;
                                    return (0, r.jsxs)(
                                      x(),
                                      {
                                        href: a,
                            ...
                            (0, r.jsxs)('div', {
                              ...
                              children: [
                                a.map((e) => {
                                  ...
                                  return (0, r.jsxs)(
                                    x(),
                                    { href: a, className: 'text-sm md:text-base', children: [l, ' ', s] },
                                    t
                                  );
                                }),
                                (0, r.jsx)(x(), {
              ...
              (0, r.jsxs)('div', {
                ...
                children: [
                  (0, r.jsxs)('main', {
                    ...
                    children: [(0, r.jsx)(s, { title: c, subtitle: o, description: x, features: h }), p],
                  }),
                  (0, r.jsx)(l, { title: c }),
                ],
              }),
  ...
  (e) => {
    var t = (t) => e((e.s = t));
    e.O(0, [6826, 1190, 636, 6593, 8792], () => t(145)), (_N_E = e.O());
  },
]);
