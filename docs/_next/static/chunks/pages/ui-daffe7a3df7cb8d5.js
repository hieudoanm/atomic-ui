  ...
  [6038],
  {
    767: (e, a, s) => {
      ...
      var d = s(1668),
        ...
        c = s.n(i);
      let o = (e) => {
        let { title: a = '', links: s = [], query: t = '', setState: d, disabledSearch: i = !1 } = e,
          { darkMode: o = !1, toggleDarkMode: x } = r();
        return (0, l.jsxs)(l.Fragment, {
          children: [
            (0, l.jsx)(n(), { children: (0, l.jsx)('title', { children: a }) }),
            (0, l.jsx)('nav', {
                      ...
                      (0, l.jsxs)('div', {
                        ...
                        children: [
                          ...
                          (0, l.jsx)('div', {
                            ...
                            children: s.map((e) => {
                              let { id: a = '', href: s = '', text: t = '' } = e;
                              return (0, l.jsx)(c(), { href: s, className: 'text-sm md:text-base', children: t }, a);
                            }),
                          }),
                        ],
                      }),
      ...
      let t = (e) => {
        ...
        return (0, l.jsx)('footer', {
          ...
          children: (0, l.jsxs)('div', {
            ...
            children: ['\xa9 ', new Date().getFullYear(), ' ⚛️ ', (0, l.jsx)('strong', { children: a })],
          }),
        });
      };
    },
    ...
    8604: (e, a, s) => {
      ...
      var l = s(5640);
      let t = (e) => {
        let { title: a = '', subtitle: s = '', description: t = '', features: r = [] } = e;
            ...
            children: (0, l.jsxs)('div', {
              ...
              children: [
                (0, l.jsxs)('header', {
                  ...
                  children: [
                    (0, l.jsxs)('h1', { className: 'text-4xl font-black whitespace-nowrap', children: ['⚛️ ', a] }),
                    (0, l.jsx)('h5', {
                              ...
                              (0, l.jsxs)(l.Fragment, {
                                children: [
                                  (0, l.jsx)('div', {
                                    ...
                                    children: u.map((e) => {
                                      let { id: a = '', emoji: s = '', group: t, name: r = '' } = e;
                                      return (0, l.jsx)(
                                        o(),
                                        {
                                          href: '#'.concat(a),
                                            ...
                                            children: (0, l.jsxs)('div', {
                                              ...
                                              children: [
                                                ...
                                                (0, l.jsxs)('div', {
                                                  ...
                                                  children: [
                                                    (0, l.jsx)('p', { className: 'text-xs capitalize', children: t }),
                                                    (0, l.jsx)('p', {
                                  ...
                                  (0, l.jsx)('div', {
                                    className: 'flex flex-col gap-y-4 md:gap-y-8',
                                    children: u.map((e) => {
                                      let { id: a = '', emoji: s = '', group: t = '', name: r = '', code: d = '' } = e;
                                      return (0, l.jsx)(
                                        'div',
                                        {
                                          className: 'flex flex-col gap-y-4',
                                          children: (0, l.jsx)(n.l, { id: a, emoji: s, group: t, name: r, code: d }),
                                        },
                                        a
                                      );
                                    }),
                              ...
                              children: [
                                ...
                                (0, l.jsx)('tbody', {
                                  ...
                                  children: [
                                    ...
                                    let { id: s = '', name: t = '', lightClass: r = '', darkClass: d = '' } = e;
                                    return (0, l.jsxs)(
                                      'tr',
                                      {
                                        children: [
                                          ...
                                          (0, l.jsx)('td', { className: 'px-3 py-2 whitespace-nowrap', children: t }),
                                          (0, l.jsx)('td', {
                                            className: 'px-3 py-2 whitespace-nowrap',
