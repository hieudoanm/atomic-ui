(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
        ...
        return (0, a.jsxs)('div', {
          ...
          children: [
              ...
              children: [
                (0, a.jsxs)('div', {
                  ...
                  children: [
                    ...
                    (0, a.jsxs)('div', {
                      children: [
                        (0, a.jsx)('p', { className: 'text-xs capitalize', children: n }),
                        (0, a.jsx)('h3', { className: 'text-xl font-bold capitalize md:text-2xl', children: s }),
                      ],
                    }),
                  ],
                }),
            ...
            (0, a.jsx)('div', {
              ...
              children: d
                ? (0, a.jsx)('div', { className: 'flex w-full items-center justify-center p-4 md:p-8', children: f })
    ...
    9781: (e, t, l) => {
      ...
      let f = {
        ...
        x = {
            ...
            (e) => {
              ...
              return (
                (0, r.useEffect)(() => {
                  ...
                  for (let e = 0; e < l.length; e++) a.fillText(l[e], d(e), n - 60 + 6);
                  ...
                  (a.quadraticCurveTo(d(t.length - 1), h(t[t.length - 1]), d(t.length - 1), h(t[t.length - 1])),
                ...
                (0, a.jsx)('div', {
                  ...
                  children: (0, a.jsx)('canvas', { ref: i, width: 400, height: 200, className: 'h-auto w-full' }),
                })
              );
            },
            { data: d, labels: h }
          ...
          bubble: (0, a.jsx)(
            (e) => {
              let { data: t = [], xLabels: l = [], yLabels: i = [], xName: n = 'X Axis', yName: s = 'Y Axis' } = e,
                o = (0, r.useRef)(null);
              return (
                (0, r.useEffect)(() => {
                  let e = o.current;
                  ...
                  ((a.strokeStyle = '#9ca3af'),
                    ...
                    t.forEach((e) => {
                      ...
                      (a.beginPath(),
                        ...
                        (a.strokeStyle = '#3b82f6'),
                        (a.lineWidth = 1),
                        a.arc(60 + ((t - u) / (g - u)) * d, 40 + ((b - l) / (b - m)) * h, r, 0, 2 * Math.PI),
                        a.fill(),
                        a.stroke());
                    }),
                    (a.fillStyle = '#374151'),
          ...
          doughnut: (0, a.jsx)(
            (e) => {
              let { data: t = [], labels: l = [], colors: i, title: n = 'Doughnut Chart' } = e,
                s = (0, r.useRef)(null),
                o = i || ['#3b82f6', '#ef4444', '#f59e0b', '#10b981', '#8b5cf6', '#ec4899', '#14b8a6'];
              return (
                (0, r.useEffect)(() => {
                  let e = s.current;
                  if (!e) return;
                ...
                (0, a.jsx)('div', {
                  className:
                    'w-full max-w-md rounded-lg border border-neutral-200 p-4 shadow dark:border-neutral-800 dark:shadow-neutral-100/10',
                  children: (0, a.jsx)('canvas', { ref: s, width: 400, height: 300, className: 'h-auto w-full' }),
                })
              );
            },
            {
            ...
            (e) => {
              ...
              return (
                (0, r.useEffect)(() => {
                  ...
                  let g = ['#3b82f6', '#ef4444', '#f59e0b', '#10b981', '#8b5cf6', '#ec4899', '#22d3ee'];
                  for (let e = 0; e < x; e++) {
                    let l = h * ((t[e] - 0) / (u - 0)),
                      r = e * c - Math.PI / 2,
                      i = r + c;
                ...
                (0, a.jsx)('div', {
                  ...
                  children: (0, a.jsx)('canvas', { ref: s, width: 400, height: 400, className: 'h-auto w-full' }),
                })
              );
            },
            {
            ...
            (e) => {
              ...
              return (
                (0, r.useEffect)(() => {
                  ...
                  for (let e = 0; e <= 5; e++) {
                    let t = 70 + (m / 5) * e;
                    (a.beginPath(), a.moveTo(t, 50), a.lineTo(t, f - 70), a.stroke());
                  }
                  ((a.strokeStyle = '#9ca3af'),
                    (a.lineWidth = 2),
                    a.beginPath(),
                  ...
                  ((a.fillStyle = s),
                    t.forEach((e) => {
                      let { x: t, y: l } = e;
                      (a.beginPath(),
                        a.arc(70 + ((t - x) / (c - x)) * m, 50 + ((g - l) / (g - u)) * b, 5, 0, 2 * Math.PI),
                        a.fill());
                    }),
                    (a.fillStyle = '#374151'),
                    (a.font = '14px sans-serif'),
  ...
  (e) => {
    (e.O(0, [7566, 4119, 5730, 636, 6593, 8792], () => e((e.s = 2625))), (_N_E = e.O()));
  },
]);
