(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [2836],
  {
    6260: (e, s, r) => {
      ...
      var t = r(5640),
        ...
        n = r(8899);
      let o = (e) => {
        let { id: s = '', emoji: r = '', group: o = '', name: d = '', code: c = '', codeOnly: u = !1 } = e,
          [p, x] = (0, i.useState)(''),
          [m, h] = (0, i.useState)(!0);
        return (
          (0, i.useEffect)(() => {
                ...
                children: [
                  (0, t.jsxs)('div', {
                    ...
                    children: [
                      ...
                      (0, t.jsxs)('div', {
                        children: [
                          (0, t.jsx)('p', { className: 'text-xs capitalize', children: o }),
                          (0, t.jsx)('h3', { className: 'text-xl font-bold md:text-2xl', children: d }),
                        ],
                      }),
                    ],
                  }),
    ...
    8899: (e, s, r) => {
      ...
      let i = (e) => {
        ...
        return (
          (0, l.useEffect)(() => {
            (async () => {
              n(await (0, a.Yz)(s, { lang: r, theme: 'github-dark' }));
            })();
          }),
          (0, t.jsx)('div', {
  ...
  (e) => {
    var s = (s) => e((e.s = s));
    e.O(0, [6826, 2182, 1190, 5695, 636, 6593, 8792], () => s(7017)), (_N_E = e.O());
  },
]);
