  ...
  [5001],
  {
    ...
    4326: (e, t, n) => {
      ...
      let _ = o.default.forwardRef(function (e, t) {
          ...
          let R = o.default.useContext(h.RouterContext),
            O = !1 !== v,
            { href: I, as: M } = o.default.useMemo(() => {
              if (!R) {
                let e = b(l);
            ...
            B = o.default.useRef(M);
          x && (r = o.default.Children.only(n));
          let U = x ? r && 'object' == typeof r && r.ref : t,
            [j, G, F] = (0, d.useIntersection)({ rootMargin: '200px' }),
            H = o.default.useCallback(
              (e) => {
                (B.current !== M || D.current !== I) &&
                  (F(), (B.current = M), (D.current = I)),
                  j(e);
              },
              [M, I, F, j]
            ),
            z = (0, m.useMergedRef)(H, U);
          o.default.useEffect(() => {
            R && G && O && y(R, I, M, { locale: A });
          }, [M, I, G, A, O, null == R ? void 0 : R.locale, R]);
          let $ = {
            ref: z,
            onClick(e) {
                  ...
                  (e.defaultPrevented ||
                    (function (e, t, n, r, i, o, a, l, u) {
                      ...
                      if (
                        ...
                        if (!(0, s.isLocalURL)(n)) {
                          i && (e.preventDefault(), location.replace(n));
                          return;
                        }
                        e.preventDefault(),
                          (() => {
          ...
          if ((0, u.isAbsoluteUrl)(M)) $.href = M;
          else if (!x || S || ('a' === r.type && !('href' in r.props))) {
            let e = void 0 !== A ? A : null == R ? void 0 : R.locale;
            $.href =
              ...
              (0, f.addBasePath)(
                (0, c.addLocale)(M, e, null == R ? void 0 : R.defaultLocale)
              );
          }
          return x
            ? o.default.cloneElement(r, $)
            : (0, i.jsx)('a', { ...L, ...$, children: n });
        }),
        v = (0, o.createContext)({ pending: !1 }),
        S = () => (0, o.useContext)(v),
        k = _;
      ('function' == typeof t.default ||
        ('object' == typeof t.default && null !== t.default)) &&
    ...
    5031: (e, t, n) => {
      ...
      var m = class {
              ...
              (function (e) {
                ...
                for (let e = 0, i = t.length; e < i; e++) {
                  ...
                  'string' == typeof o.settings.foreground &&
                    p(o.settings.foreground) &&
                    (s = o.settings.foreground);
                  let l = null;
                  'string' == typeof o.settings.background &&
                    p(o.settings.background) &&
                    (l = o.settings.background);
                  for (let t = 0, o = i.length; t < o; t++) {
                    let o = i[t].trim().split(' '),
                      u = o[o.length - 1],
                      c = null;
                    o.length > 1 && (c = o.slice(0, o.length - 1)).reverse(),
                      (n[r++] = new _(u, c, e, a, s, l));
                  }
                }
                return n;
              })(e),
          ...
          static createFromParsedTheme(e, t) {
            return (function (e, t) {
              e.sort((e, t) => {
                ...
                return 0 !== i || 0 !== (i = d(e.parentScopes, t.parentScopes))
                  ? i
                  : e.index - t.index;
              });
              let n = 0,
              ...
              for (let t = 0, n = e.length; t < n; t++) {
                ...
                s.insert(
                  ...
                  n.parentScopes,
                  n.fontStyle,
                  o.getId(n.foreground),
                  o.getId(n.background)
                );
              }
              return new g(o, a, s);
            })(e, t);
        ...
        C = class e {
          ...
          insert(t, n, r, i, o, a) {
            ...
            -1 === c
              ? ((s = n), (l = ''))
              : ((s = n.substring(0, c)), (l = n.substring(c + 1))),
              this._children.hasOwnProperty(s)
                ? (u = this._children[s])
                : ((u = new e(
                    this._mainRule.clone(),
                    w.cloneArr(this._rulesWithParentScopes)
                  )),
                  (this._children[s] = u)),
          ...
          _doInsertHere(e, t, n, r, i) {
            if (null === t)
              return void this._mainRule.acceptOverwrite(e, n, r, i);
            for (
              let o = 0, a = this._rulesWithParentScopes.length;
              o < a;
              o++
            ) {
              let a = this._rulesWithParentScopes[o];
              if (0 === d(a.parentScopes, t))
        ...
        O = class {
          constructor(e, t) {
            (this.repo = e),
              ...
              (this.Q = [new x(this.initialScopeName)]);
          }
          ...
          processQueue() {
            ...
            for (let n of e)
              !(function (e, t, n, r) {
                ...
                if (a) for (let e of a) r.add(new x(e));
      ...
      function D(e, t, n) {
        for (let r of e) {
          ...
          n.visitedRule.add(r);
          let e = r.repository
            ? l({}, t.repository, r.repository)
            : t.repository;
          Array.isArray(r.patterns) &&
            D(r.patterns, { ...t, repository: e }, n);
          let i = r.include;
          if (!i) continue;
          let o = H(i);
          switch (o.kind) {
            ...
            case 4:
              ...
              if (a) {
                ...
                4 === o.kind
                  ? n.add(new L(o.scopeName, o.ruleName))
                  : n.add(new x(o.scopeName));
          }
        }
      }
      var B = class {
      ...
      function H(e) {
        ...
        return -1 === t
          ...
          : 0 === t
            ? new j(e.substring(1))
            : new F(e.substring(0, t), e.substring(t + 1));
      }
      var z = /\\(\d+)/,
        $ = /\\(\d+)/g;
      Symbol('RuleId');
      var W = class {
        ...
        K = class extends W {
          ...
          _getCachedCompiledPatterns(e, t) {
            if (!this._cachedCompiledPatterns) {
              for (let t of ((this._cachedCompiledPatterns = new Z()),
              this.patterns))
        ...
        Q = class e {
          ...
          resolveBackReferences(e, t) {
            ...
            return (
              ($.lastIndex = 0),
              this.source.replace($, (e, t) => f(n[parseInt(t, 10)] || ''))
            );
          }
          _buildAnchorCache() {
            let e, t, n, r;
        ...
        en = class e {
          ...
          constructor(e, t) {
            (this._defaultAttributes = new et(e, 8)),
              (this._embeddedLanguagesMatcher = new er(
                Object.entries(t || {})
              ));
          }
          ...
          _getBasicScopeAttributes = new m(
            (e) =>
              new et(this._scopeToLanguage(e), this._toStandardTokenType(e))
          );
          _scopeToLanguage(e) {
      ...
      function eo(e, t, n, r, i, o, a, s) {
        ...
        if (a) {
          let a = (function (e, t, n, r, i, o) {
            ...
            for (let p = s.pop(); p; p = s.pop()) {
              var l, u, c, h, d;
              let { ruleScanner: s, findOptions: f } =
                  ((l = p.rule),
                  (u = e),
                  (c = p.stack.endRule),
                  (h = n),
                  (d = r === a),
                  {
                    ruleScanner: l.compileWhileAG(u, c, h, d),
                    findOptions: 0,
                  }),
                m = s.findNextMatchSync(t, r, f);
              if (m) {
                if (-2 !== m.ruleId) {
                  i = p.stack.pop();
                  break;
                ...
                m.captureIndices &&
                  ...
                  (o.produce(p.stack, m.captureIndices[0].start),
                  es(
                    e,
                    t,
                    n,
                    p.stack,
                    o,
                    p.rule.whileCaptures,
                    m.captureIndices
                  ),
                  o.produce(p.stack, m.captureIndices[0].end),
                  (a = m.captureIndices[0].end),
                  m.captureIndices[0].end > r &&
                    ((r = m.captureIndices[0].end), (n = !1)));
              } else {
                i = p.stack.pop();
                break;
              }
        ...
        for (; !u; ) {
          ...
          !(function () {
            let a = (function (e, t, n, r, i, o) {
              let a = (function (e, t, n, r, i, o) {
                  let { ruleScanner: a, findOptions: s } = ea(
                      i.getRule(e),
                      e,
                      i.endRule,
                      n,
              ...
              let l = (function (e, t, n, r, i, o, a) {
                ...
                for (let o = 0, d = e.length; o < d; o++) {
                  ...
                  let { ruleScanner: p, findOptions: f } = ea(
                      t.getRule(d.ruleId),
                      t,
                      null,
                      r,
                    ...
                    m = p.findNextMatchSync(n, i, f);
                  if (!m) continue;
                  let g = m.captureIndices[0].start;
                  if (
                    !(g >= l) &&
                    ((l = g),
                    (u = m.captureIndices),
            ...
            if (-1 === h) {
              ...
              o.produce(i, s[0].start);
              let p = i,
                f = a.getName(t.content, s),
                m = i.contentNameScopesList.pushAttributed(f, e);
              if (
                ((i = i.push(h, r, c, s[0].end === l, null, m, m)),
                a instanceof K)
              ) {
                es(e, t, n, i, o, a.beginCaptures, s),
                  o.produce(i, s[0].end),
                  (c = s[0].end);
                let r = a.getContentName(t.content, s),
                  h = m.pushAttributed(r, e);
                if (
                  ((i = i.withContentNameScopesList(h)),
                  a.endHasBackReferences &&
                    (i = i.withEndRule(
                      a.getEndWithResolvedBackReferences(t.content, s)
                    )),
                  !d && p.hasSameRuleAs(i))
                ) {
                ...
                if (
                  ...
                  a.whileHasBackReferences &&
                    (i = i.withEndRule(
                      a.getWhileWithResolvedBackReferences(t.content, s)
                    )),
                  !d && p.hasSameRuleAs(i))
                ) {
                  (i = i.pop()), o.produce(i, l), (u = !0);
      ...
      function es(e, t, n, r, i, o, a) {
        ...
        for (let t = 0; t < l; t++) {
          ...
          for (; u.length > 0 && u[u.length - 1].endPos <= h.start; )
            i.produceFromScopes(u[u.length - 1].scopes, u[u.length - 1].endPos),
              u.pop();
          if (
            (u.length > 0
              ? i.produceFromScopes(u[u.length - 1].scopes, h.start)
              : i.produce(r, h.start),
            ...
            let t = l.getName(s, a),
              ...
              p = e.createOnigString(s.substring(0, h.end));
            eo(e, p, n && 0 === h.start, h.start, d, i, !1, 0), P(p);
            continue;
          }
          let d = l.getName(s, a);
          if (null !== d) {
      ...
      var eh = class {
        ...
        _tokenize(e, t, n, r) {
          ...
          if (
            (-1 === this._rootId &&
              ((this._rootId = J.getCompiledRuleId(
            ...
            (e = a
              ? ep.createRootAndLookUpScopeName(a, o, this)
              : ep.createRoot('unknown', o)),
              (t = new ef(null, this._rootId, -1, -1, !1, null, e, e));
          }
          e += '\n';
      ...
      var ep = class e {
          ...
          static _equals(e, t) {
            return (
              ...
              (!!this._structuralEquals(e, t) &&
                ep.equals(e.contentNameScopesList, t.contentNameScopesList))
            );
          }
            ...
            if (this._emitBinaryTokens) {
              ...
              if (
                ...
                for (let e of this._tokenTypeOverrides)
                  e.matcher(t) && (n = A.set(n, 0, e.type, null, -1, 0, 0));
                this.balancedBracketSelectors &&
        ...
        ey = class {
          ...
          grammarForScopeName(e, t, n, r, i) {
            if (!this._grammars.has(e)) {
              ...
              this._grammars.set(
                e,
                new eh(e, o, t, n, r, i, this, this._onigLib)
              );
            }
        ...
        eb = class {
          ...
          _loadGrammar(e, t, n, r, i) {
            ...
            for (; o.Q.length > 0; )
              o.Q.map((e) => this._loadSingleGrammar(e.scopeName)),
                o.processQueue();
      ...
      let eG = eD({
        ...
        eF = eD({
          ...
          properties: {
            ...
            stopColor: null,
            stopOpacity: null,
            strikethroughPosition: eP,
            strikethroughThickness: eP,
            string: null,
            stroke: null,
            strokeDashArray: eR,
            ...
            u1: null,
            u2: null,
            underlinePosition: eP,
            underlineThickness: eP,
            unicode: null,
            unicodeBidi: null,
            unicodeRange: null,
            unitsPerEm: eP,
        ...
        e5 = {}.hasOwnProperty,
        e8 = {};
      for (r in e2) e5.call(e2, r) && (e8[e2[r]] = r);
      let e6 = /[^\dA-Za-z]/;
      function e4(e, t, n) {
        let r,
          i = (function (e, t, n) {
            ...
            (r = (function (e, t, n, r) {
              ...
              if (e5.call(e8, i)) {
                ...
                return n &&
                  e1.includes(e) &&
                  !e3.includes(e) &&
                  (!r || (t && 61 !== t && e6.test(String.fromCharCode(t))))
                  ? o
                  : o + ';';
              }
              return '';
      ...
      let ty = tg({
        ...
        dd: function (e, t, n) {
          ...
          return (
            !r ||
            ('element' === r.type && ('dt' === r.tagName || 'dd' === r.tagName))
          );
        },
        dt: function (e, t, n) {
          let r = th(n, t);
        ...
        option: function (e, t, n) {
          ...
          return (
            !r ||
            ('element' === r.type &&
              ('option' === r.tagName || 'optgroup' === r.tagName))
          );
        },
        p: function (e, t, n) {
          let r = th(n, t);
        ...
        tbody: function (e, t, n) {
          ...
          return (
            !r ||
            ('element' === r.type &&
              ('tbody' === r.tagName || 'tfoot' === r.tagName))
          );
        },
        td: tv,
      ...
      function tb(e, t, n) {
        ...
        return (
          !r ||
          ('comment' !== r.type &&
            !('text' === r.type && tu(r.value.charAt(0))))
        );
      }
      function t_(e, t, n) {
        let r = th(n, t);
        return (
          !r ||
          ('element' === r.type && ('rp' === r.tagName || 'rt' === r.tagName))
        );
      }
      function tv(e, t, n) {
        let r = th(n, t);
        return (
          !r ||
          ('element' === r.type && ('td' === r.tagName || 'th' === r.tagName))
        );
      }
      let tS = tg({
          body: function (e) {
      ...
      function tC(e, t, n, r) {
        return n &&
          ...
          : e9(
              e.value,
              Object.assign({}, r.settings.characterReferences, { subset: tw })
            );
      }
      let tA = (function (e, t) {
          let n = t || {};
          ...
          handlers: {
            ...
            element: function (e, t, n, r) {
              ...
              let u = (function (e, t) {
                            ...
                            : (e.settings.preferUnquoted &&
                                (r = e9(
                                  ...
                                  Object.assign(
                                    ...
                                    { attribute: !0, subset: tk.unquoted[o][a] }
                                  )
                                )),
                              r !== n &&
                                (e.settings.quoteSmart &&
                                  tn(n, s) > tn(n, e.alternative) &&
                                  (s = e.alternative),
                                (r =
                                  s +
                                  e9(
                ...
                c = r.all(
                  'html' === o.space && 'template' === e.tagName ? e.content : e
                );
              return (
                (r.schema = o),
                c && (s = !1),
      ...
      function tj(e) {
        ...
        if (
          ...
          e.fontStyle & v.Italic && (t['font-style'] = 'italic'),
            e.fontStyle & v.Bold && (t['font-weight'] = 'bold');
          let n = [];
      ...
      class t$ {
        ...
        static initial(e, t) {
          return new t$(
            Object.fromEntries(
              (Array.isArray(t) ? t : [t]).map((e) => [e, e_])
            ),
            e
          );
        }
            ...
            if (!e.has(t.meta)) {
              let n = function (e) {
                  ...
                  }
                  {
                    ...
                    if (void 0 === t)
                      throw new a(
                        `Invalid decoration position ${JSON.stringify(e)}. Lines length: ${r.lines.length}`
                      );
          ...
          return {
            ...
            tokens(e) {
              if (this.options.decorations?.length) {
                var n = e,
                  r = t(this).decorations.flatMap((e) => [
                    e.start.offset,
                    e.end.offset,
                  ]);
                let i = Array.from(r instanceof Set ? r : new Set(r)).sort(
                  (e, t) => e - t
                );
                return i.length
                  ? n.map((e) =>
            ...
            code(e) {
              ...
              function i(e, t, n, i) {
                ...
                if (-1 === u)
                  throw new a(
                    `Failed to find start index for decoration ${JSON.stringify(i.start)}`
                  );
                if (-1 === c)
                  throw new a(
                    `Failed to find end index for decoration ${JSON.stringify(i.end)}`
                  );
      ...
      function tJ(e, t, n = {}) {
        ...
        if (tI(r) || tD(i))
          return tU(t).map((e) => [{ content: e[0], offset: e[1] }]);
        ...
        var u = t,
          ...
          p = n;
        let f = tQ(u, c, h, d, p),
          m = new t$(tQ(u, c, h, d, p).stateStack, c.name, h.name);
        return tH(f.tokens, m), f.tokens;
      }
      function tQ(e, t, n, r, i) {
        ...
        for (let e = 0, a = u.length; e < a; e++) {
          ...
          if (s > 0 && f.length >= s) {
            (h = []),
              d.push([{ content: f, offset: m, color: '', fontStyle: 0 }]);
            continue;
          }
          i.includeExplanation &&
            ((a = t.tokenizeLine(f, c, l).tokens), (p = 0));
          let g = t.tokenizeLine2(f, c, l),
            y = g.tokens.length / 2;
          for (let e = 0; e < y; e++) {
            let t = g.tokens[2 * e],
              s = e + 1 < y ? g.tokens[2 * e + 2] : f.length;
            if (t === s) continue;
            let l = g.tokens[2 * e + 1],
              u = tR(r[A.getForeground(l)], o),
              c = A.getFontStyle(l),
              d = {
                content: f.substring(t, s),
                offset: m + t,
                color: u,
                fontStyle: c,
              };
      ...
      function t1(e, t, n) {
        let r, i, o, s, l, u;
        if ('themes' in n) {
          let { defaultColor: c = 'light', cssVariablePrefix: h = '--shiki-' } =
              n,
            d = Object.entries(n.themes)
              .filter((e) => e[1])
              .map((e) => ({ color: e[0], theme: e[1] }))
              .sort((e, t) => (e.color === c ? -1 : +(t.color === c)));
          if (0 === d.length) throw new a('`themes` option must not be empty');
          let p = t0(e, t, n);
          if (((u = tz(p)), c && !d.find((e) => e.color === c)))
            throw new a(
              `\`themes\` option must contain the defaultColor key \`${c}\``
            );
          let f = d.map((t) => e.getTheme(t.theme)),
            m = d.map((e) => e.color);
          (o = p.map((e) =>
            e.map((e) =>
              (function (e, t, n, r) {
            ...
            u && tH(o, u);
          let g = d.map((e) => tL(e.theme, n));
          (i = d
            .map(
              (e, t) =>
                (0 === t && c ? '' : `${h + e.color}:`) +
                (tR(f[t].fg, g[t]) || 'inherit')
            )
            .join(';')),
            (r = d
              .map(
      ...
      function t2(
        ...
        r = {
          meta: {},
          options: n,
          codeToHast: (t, n) => t2(e, t, n),
          codeToTokens: (t, n) => t1(e, t, n),
        }
      ) {
        let i = t;
        ...
        let {
          ...
          { mergeWhitespaces: h = !0, mergeSameStyleTokens: d = !1 } = n;
        !0 === h
          ? (o = o.map((e) => {
              let t = [],
                n = '',
              ...
              return (
                e.forEach((i, o) => {
                  let a = !(
                    i.fontStyle &&
                    (i.fontStyle & v.Underline || i.fontStyle & v.Strikethrough)
                  );
          ...
          d &&
            (o = o.map((e) => {
              ...
              for (let n of e) {
                ...
                let e = t[t.length - 1],
                  r = e.htmlStyle || tG(tj(e)),
                  i = n.htmlStyle || tG(tj(n)),
                  o =
                    e.fontStyle &&
                    (e.fontStyle & v.Underline ||
                      e.fontStyle & v.Strikethrough),
                  a =
                    n.fontStyle &&
                    (n.fontStyle & v.Underline ||
                      n.fontStyle & v.Strikethrough);
        ...
        for (let e of tq(n)) o = e.tokens?.call(p, o) || o;
        return (function (e, t, n, r = tz(e)) {
          ...
          if (
            (e.forEach((e, t) => {
              ...
              for (let o of e) {
                let e = {
                  ...
                  l = tG(o.htmlStyle || tj(o));
                for (let a of (l && (e.properties.style = l), i))
                  e = a?.span?.call(d, e, t + 1, r, n, o) || e;
                'inline' === s
                  ? a.children.push(e)
                  : 'classic' === s && n.children.push(e),
                  (r += o.content.length);
              }
              if ('classic' === s) {
            ...
            for (let e of i) c = e?.code?.call(d, c) || c;
            for (let e of (u.children.push(c), i)) u = e?.pre?.call(d, u) || u;
            a.children.push(u);
          }
          let p = a;
          for (let e of i) p = e?.root?.call(d, p) || p;
          return r && tH(p, r), p;
        })(o, { ...n, fg: a, bg: s, themeName: l, rootStyle: u }, p, c);
      }
      let t3 = function (e, t) {
          let n = t || tT,
            r = n.quote || '"';
      ...
      function t4(e) {
        ...
        if (!n || !r) {
          ...
          e?.settings?.foreground && (r = e.settings.foreground),
            ...
            n || (n = 'light' === t.type ? t8.light : t8.dark),
            (t.fg = r),
            (t.bg = n);
        }
            ...
            (
              await Promise.all(
                e
                  ...
                  .map(
                    async (e) =>
                      await tO(e).then((e) => (Array.isArray(e) ? e : [e]))
                  )
              )
            ).flat()
          )
      ...
      async function t7(e) {
        return (
          await Promise.all(
            e.map(async (e) => (tD(e) ? null : t4(await tO(e))))
          )
        ).filter((e) => !!e);
      }
      ...
      class nt extends eb {
        ...
        setTheme(e) {
          ...
          t ||
            ((t = g.createFromRawTheme(e)), this._textmateThemeCache.set(e, t)),
        ...
        return (function (e) {
          ...
          return {
            setTheme: function (e) {
              ...
              let n = a(e);
              return (
                t !== e && (o.setTheme(n), (t = e)),
                { theme: n, colorMap: o.getColorMap() }
              );
            },
            getTheme: a,
      ...
      let na = [
          {
            id: 'abap',
            name: 'ABAP',
            import: () => n.e(1310).then(n.bind(n, 1310)),
          },
          {
            id: 'actionscript-3',
            name: 'ActionScript',
            import: () => n.e(8215).then(n.bind(n, 8215)),
          },
          {
            id: 'ada',
            name: 'Ada',
            import: () => n.e(7270).then(n.bind(n, 7270)),
          },
          {
            id: 'angular-html',
            name: 'Angular HTML',
            import: () =>
              Promise.all([n.e(6705), n.e(3939), n.e(947), n.e(2488)]).then(
                n.bind(n, 2488)
              ),
          },
          {
          ...
          },
          {
            id: 'apache',
            name: 'Apache Conf',
            import: () => n.e(4006).then(n.bind(n, 4006)),
          },
          {
            id: 'apex',
            name: 'Apex',
            import: () => n.e(6952).then(n.bind(n, 6952)),
          },
          {
            id: 'apl',
            name: 'APL',
          ...
          },
          {
            id: 'applescript',
            name: 'AppleScript',
            import: () => n.e(9539).then(n.bind(n, 9539)),
          },
          {
            id: 'ara',
            name: 'Ara',
            import: () => n.e(7355).then(n.bind(n, 9736)),
          },
          {
            id: 'asciidoc',
            name: 'AsciiDoc',
            aliases: ['adoc'],
            import: () => n.e(8693).then(n.bind(n, 8693)),
          },
          {
            id: 'asm',
            name: 'Assembly',
            import: () => n.e(347).then(n.bind(n, 347)),
          },
          {
            id: 'astro',
            name: 'Astro',
            import: () =>
              Promise.all([n.e(6705), n.e(4402), n.e(3939), n.e(5599)]).then(
                n.bind(n, 5599)
              ),
          },
          {
            id: 'awk',
            name: 'AWK',
            import: () => n.e(3573).then(n.bind(n, 3573)),
          },
          {
            id: 'ballerina',
            name: 'Ballerina',
            import: () => n.e(4742).then(n.bind(n, 4742)),
          },
          {
            id: 'bat',
            name: 'Batch File',
            aliases: ['batch'],
            import: () => n.e(5123).then(n.bind(n, 5123)),
          },
          {
            id: 'beancount',
            name: 'Beancount',
            import: () => n.e(1341).then(n.bind(n, 1341)),
          },
          {
            id: 'berry',
            name: 'Berry',
            aliases: ['be'],
            import: () => n.e(4474).then(n.bind(n, 4474)),
          },
          {
            id: 'bibtex',
            name: 'BibTeX',
            import: () => n.e(7442).then(n.bind(n, 7442)),
          },
          {
            id: 'bicep',
            name: 'Bicep',
            import: () => n.e(6411).then(n.bind(n, 6411)),
          },
          {
            id: 'blade',
            name: 'Blade',
          ...
          },
          {
            ...
            name: '1C (Enterprise)',
            aliases: ['1c'],
            import: () => n.e(1953).then(n.bind(n, 1953)),
          },
          { id: 'c', name: 'C', import: () => n.e(5233).then(n.bind(n, 5233)) },
          {
            ...
            name: 'Cadence',
            aliases: ['cdc'],
            import: () => n.e(1711).then(n.bind(n, 1711)),
          },
          {
            id: 'cairo',
            name: 'Cairo',
            import: () =>
              Promise.all([n.e(3034), n.e(7542)]).then(n.bind(n, 7542)),
          },
          {
            id: 'clarity',
            name: 'Clarity',
            import: () => n.e(1394).then(n.bind(n, 1394)),
          },
          {
            id: 'clojure',
            name: 'Clojure',
            aliases: ['clj'],
            import: () => n.e(2294).then(n.bind(n, 2294)),
          },
          {
            id: 'cmake',
            name: 'CMake',
            import: () => n.e(7403).then(n.bind(n, 7403)),
          },
          {
            id: 'cobol',
            name: 'COBOL',
          ...
          },
          {
            id: 'codeowners',
            name: 'CODEOWNERS',
            import: () => n.e(1043).then(n.bind(n, 1043)),
          },
          {
            id: 'codeql',
            name: 'CodeQL',
            aliases: ['ql'],
            import: () => n.e(4520).then(n.bind(n, 4520)),
          },
          {
            id: 'coffee',
            name: 'CoffeeScript',
            ...
            import: () =>
              Promise.all([n.e(6705), n.e(9736)]).then(n.bind(n, 7355)),
          },
          {
            id: 'common-lisp',
            name: 'Common Lisp',
            aliases: ['lisp'],
            import: () => n.e(8218).then(n.bind(n, 8218)),
          },
          {
            id: 'coq',
            name: 'Coq',
            import: () => n.e(8793).then(n.bind(n, 8793)),
          },
          {
            id: 'cpp',
            name: 'C++',
          ...
          },
          {
            ...
            name: 'C#',
            aliases: ['c#', 'cs'],
            import: () => n.e(3193).then(n.bind(n, 3193)),
          },
          {
            id: 'css',
            name: 'CSS',
            import: () => n.e(3939).then(n.bind(n, 3939)),
          },
          {
            id: 'csv',
            name: 'CSV',
            import: () => n.e(842).then(n.bind(n, 842)),
          },
          {
            id: 'cue',
            name: 'CUE',
            import: () => n.e(6003).then(n.bind(n, 6003)),
          },
          {
            id: 'cypher',
            name: 'Cypher',
            aliases: ['cql'],
            import: () => n.e(1241).then(n.bind(n, 1241)),
          },
          { id: 'd', name: 'D', import: () => n.e(4350).then(n.bind(n, 4350)) },
          {
            id: 'dart',
            name: 'Dart',
            import: () => n.e(2883).then(n.bind(n, 2883)),
          },
          {
            id: 'dax',
            name: 'DAX',
            import: () => n.e(2513).then(n.bind(n, 2513)),
          },
          {
            id: 'desktop',
            name: 'Desktop',
            import: () => n.e(1094).then(n.bind(n, 1094)),
          },
          {
            id: 'diff',
            name: 'Diff',
            import: () => n.e(297).then(n.bind(n, 297)),
          },
          {
            id: 'docker',
            name: 'Dockerfile',
            aliases: ['dockerfile'],
            import: () => n.e(2772).then(n.bind(n, 2772)),
          },
          {
            id: 'dotenv',
            name: 'dotEnv',
            import: () => n.e(5898).then(n.bind(n, 5898)),
          },
          {
            id: 'dream-maker',
            name: 'Dream Maker',
            import: () => n.e(6912).then(n.bind(n, 6912)),
          },
          {
            id: 'edge',
            name: 'Edge',
          ...
          },
          {
            ...
            name: 'Elixir',
            import: () =>
              Promise.all([n.e(6705), n.e(3939), n.e(947), n.e(2833)]).then(
                n.bind(n, 2833)
              ),
          },
          {
            ...
            name: 'Elm',
            import: () =>
              Promise.all([n.e(5233), n.e(7350)]).then(n.bind(n, 7350)),
          },
          {
            id: 'emacs-lisp',
            name: 'Emacs Lisp',
            aliases: ['elisp'],
            import: () => n.e(5428).then(n.bind(n, 4398)),
          },
          {
            id: 'erb',
            name: 'ERB',
          ...
          },
          {
            ...
            name: 'Erlang',
            aliases: ['erl'],
            import: () => n.e(8113).then(n.bind(n, 8113)),
          },
          {
            id: 'fennel',
            name: 'Fennel',
            import: () => n.e(7576).then(n.bind(n, 7576)),
          },
          {
            id: 'fish',
            name: 'Fish',
          ...
          },
          {
            ...
            name: 'Fluent',
            aliases: ['ftl'],
            import: () => n.e(5526).then(n.bind(n, 5526)),
          },
          {
            ...
            aliases: ['f', 'for', 'f77'],
            import: () =>
              Promise.all([n.e(2358), n.e(482)]).then(n.bind(n, 482)),
          },
          {
          ...
          },
          {
            ...
            aliases: ['f#', 'fs'],
            import: () =>
              Promise.all([n.e(6639), n.e(2934)]).then(n.bind(n, 2934)),
          },
          {
            id: 'gdresource',
            name: 'GDResource',
            import: () => n.e(5173).then(n.bind(n, 5173)),
          },
          {
            id: 'gdscript',
            name: 'GDScript',
            import: () => n.e(1775).then(n.bind(n, 4156)),
          },
          {
            id: 'gdshader',
            name: 'GDShader',
            import: () => n.e(10).then(n.bind(n, 10)),
          },
          {
            id: 'genie',
            name: 'Genie',
            import: () => n.e(2502).then(n.bind(n, 2502)),
          },
          {
            id: 'gherkin',
            name: 'Gherkin',
            import: () => n.e(2588).then(n.bind(n, 2588)),
          },
          {
            id: 'git-commit',
            name: 'Git Commit Message',
            import: () => n.e(8498).then(n.bind(n, 8498)),
          },
          {
            id: 'git-rebase',
            name: 'Git Rebase Message',
            import: () =>
              Promise.all([n.e(7917), n.e(7537)]).then(n.bind(n, 7537)),
          },
          {
            id: 'gleam',
            name: 'Gleam',
            import: () => n.e(906).then(n.bind(n, 906)),
          },
          {
            id: 'glimmer-js',
            name: 'Glimmer JS',
          ...
          },
          {
            ...
            name: 'GLSL',
            import: () =>
              Promise.all([n.e(5233), n.e(5048)]).then(n.bind(n, 5048)),
          },
          {
            id: 'gnuplot',
            name: 'Gnuplot',
            import: () => n.e(6635).then(n.bind(n, 6635)),
          },
          {
            id: 'go',
            name: 'Go',
            import: () => n.e(6182).then(n.bind(n, 6182)),
          },
          {
            id: 'graphql',
            name: 'GraphQL',
          ...
          },
          {
            id: 'groovy',
            name: 'Groovy',
            import: () => n.e(7610).then(n.bind(n, 7610)),
          },
          {
            id: 'hack',
            name: 'Hack',
          ...
          },
          {
            ...
            name: 'Ruby Haml',
            import: () =>
              Promise.all([n.e(6705), n.e(3939), n.e(5934)]).then(
                n.bind(n, 5934)
              ),
          },
          {
            ...
            aliases: ['hbs'],
            import: () =>
              Promise.all([n.e(6705), n.e(3939), n.e(947), n.e(8572)]).then(
                n.bind(n, 8572)
              ),
          },
          {
            ...
            name: 'Haskell',
            aliases: ['hs'],
            import: () => n.e(1250).then(n.bind(n, 1250)),
          },
          {
            id: 'haxe',
            name: 'Haxe',
            import: () => n.e(4856).then(n.bind(n, 4856)),
          },
          {
            id: 'hcl',
            name: 'HashiCorp HCL',
            import: () => n.e(2267).then(n.bind(n, 2267)),
          },
          {
            id: 'hjson',
            name: 'Hjson',
            import: () => n.e(7676).then(n.bind(n, 7676)),
          },
          {
            id: 'hlsl',
            name: 'HLSL',
            import: () => n.e(6517).then(n.bind(n, 6517)),
          },
          {
            id: 'html',
            name: 'HTML',
            import: () =>
              Promise.all([n.e(6705), n.e(3939), n.e(947)]).then(
                n.bind(n, 947)
              ),
          },
          {
            ...
            import: () =>
              Promise.all([n.e(6705), n.e(3939), n.e(947), n.e(5005)]).then(
                n.bind(n, 5005)
              ),
          },
          {
          ...
          },
          {
            id: 'hxml',
            name: 'HXML',
            import: () => n.e(5135).then(n.bind(n, 5135)),
          },
          {
            id: 'hy',
            name: 'Hy',
            import: () => n.e(8065).then(n.bind(n, 8065)),
          },
          {
            id: 'imba',
            name: 'Imba',
            import: () => n.e(8381).then(n.bind(n, 8381)),
          },
          {
            id: 'ini',
            name: 'INI',
            aliases: ['properties'],
            import: () => n.e(4036).then(n.bind(n, 4036)),
          },
          {
            id: 'java',
            name: 'Java',
            import: () => n.e(2268).then(n.bind(n, 2268)),
          },
          {
            id: 'javascript',
            name: 'JavaScript',
            aliases: ['js'],
            import: () => n.e(6705).then(n.bind(n, 8958)),
          },
          {
            id: 'jinja',
            name: 'Jinja',
            import: () =>
              Promise.all([n.e(6705), n.e(3939), n.e(947), n.e(7522)]).then(
                n.bind(n, 7522)
              ),
          },
          {
            ...
            name: 'Jison',
            import: () =>
              Promise.all([n.e(6705), n.e(379)]).then(n.bind(n, 379)),
          },
          {
            id: 'json',
            name: 'JSON',
            import: () => n.e(1086).then(n.bind(n, 1086)),
          },
          {
            id: 'json5',
            name: 'JSON5',
            import: () => n.e(4697).then(n.bind(n, 4697)),
          },
          {
            id: 'jsonc',
            name: 'JSON with Comments',
            import: () => n.e(3315).then(n.bind(n, 5696)),
          },
          {
            id: 'jsonl',
            name: 'JSON Lines',
            import: () => n.e(5596).then(n.bind(n, 5596)),
          },
          {
            id: 'jsonnet',
            name: 'Jsonnet',
            import: () => n.e(5469).then(n.bind(n, 5469)),
          },
          {
            id: 'jssm',
            name: 'JSSM',
            aliases: ['fsl'],
            import: () => n.e(6337).then(n.bind(n, 6337)),
          },
          {
            id: 'jsx',
            name: 'JSX',
            import: () => n.e(2422).then(n.bind(n, 2437)),
          },
          {
            id: 'julia',
            name: 'Julia',
          ...
          },
          {
            ...
            name: 'Kotlin',
            aliases: ['kt', 'kts'],
            import: () => n.e(1447).then(n.bind(n, 1447)),
          },
          {
            id: 'kusto',
            name: 'Kusto',
            aliases: ['kql'],
            import: () => n.e(2410).then(n.bind(n, 2410)),
          },
          {
            id: 'latex',
            name: 'LaTeX',
            import: () =>
              Promise.all([n.e(6588), n.e(9622)]).then(n.bind(n, 9622)),
          },
          {
            id: 'lean',
            name: 'Lean 4',
            aliases: ['lean4'],
            import: () => n.e(212).then(n.bind(n, 212)),
          },
          {
            id: 'less',
            name: 'Less',
            import: () => n.e(4051).then(n.bind(n, 4051)),
          },
          {
            id: 'liquid',
            name: 'Liquid',
            import: () =>
              Promise.all([n.e(6705), n.e(3939), n.e(947), n.e(8196)]).then(
                n.bind(n, 8196)
              ),
          },
          {
            id: 'llvm',
            name: 'LLVM IR',
            import: () => n.e(9415).then(n.bind(n, 9415)),
          },
          {
            id: 'log',
            name: 'Log file',
            import: () => n.e(1936).then(n.bind(n, 1936)),
          },
          {
            id: 'logo',
            name: 'Logo',
            import: () => n.e(8481).then(n.bind(n, 8481)),
          },
          {
            id: 'lua',
            name: 'Lua',
            import: () =>
              Promise.all([n.e(5233), n.e(9480)]).then(n.bind(n, 9480)),
          },
          {
            id: 'luau',
            name: 'Luau',
            import: () => n.e(6287).then(n.bind(n, 6287)),
          },
          {
            id: 'make',
            name: 'Makefile',
            aliases: ['makefile'],
            import: () => n.e(7066).then(n.bind(n, 7066)),
          },
          {
            id: 'markdown',
            name: 'Markdown',
            aliases: ['md'],
            import: () => n.e(6639).then(n.bind(n, 6639)),
          },
          {
            id: 'marko',
            name: 'Marko',
          ...
          },
          {
            id: 'matlab',
            name: 'MATLAB',
            import: () => n.e(5311).then(n.bind(n, 5311)),
          },
          {
            id: 'mdc',
            name: 'MDC',
          ...
          },
          {
            id: 'mdx',
            name: 'MDX',
            import: () => n.e(2263).then(n.bind(n, 2263)),
          },
          {
            id: 'mermaid',
            name: 'Mermaid',
            aliases: ['mmd'],
            import: () => n.e(8707).then(n.bind(n, 8707)),
          },
          {
            id: 'mipsasm',
            name: 'MIPS Assembly',
            aliases: ['mips'],
            import: () => n.e(2476).then(n.bind(n, 2476)),
          },
          {
            id: 'mojo',
            name: 'Mojo',
            import: () => n.e(1029).then(n.bind(n, 1029)),
          },
          {
            id: 'move',
            name: 'Move',
            import: () => n.e(9391).then(n.bind(n, 9391)),
          },
          {
            id: 'narrat',
            name: 'Narrat Language',
            aliases: ['nar'],
            import: () => n.e(7688).then(n.bind(n, 7688)),
          },
          {
            id: 'nextflow',
            name: 'Nextflow',
            aliases: ['nf'],
            import: () => n.e(2419).then(n.bind(n, 2419)),
          },
          {
            id: 'nginx',
            name: 'Nginx',
            import: () =>
              Promise.all([n.e(5233), n.e(4682)]).then(n.bind(n, 4682)),
          },
          {
            id: 'nim',
            name: 'Nim',
          ...
          },
          {
            id: 'nix',
            name: 'Nix',
            import: () => n.e(2379).then(n.bind(n, 2379)),
          },
          {
            id: 'nushell',
            name: 'nushell',
            aliases: ['nu'],
            import: () => n.e(8629).then(n.bind(n, 8629)),
          },
          {
            id: 'objective-c',
            name: 'Objective-C',
          ...
          },
          {
            id: 'objective-cpp',
            name: 'Objective-C++',
            import: () => n.e(8894).then(n.bind(n, 2695)),
          },
          {
            id: 'ocaml',
            name: 'OCaml',
            import: () => n.e(350).then(n.bind(n, 350)),
          },
          {
            id: 'pascal',
            name: 'Pascal',
            import: () => n.e(2876).then(n.bind(n, 2876)),
          },
          {
            id: 'perl',
            name: 'Perl',
          ...
          },
          {
            id: 'plsql',
            name: 'PL/SQL',
            import: () => n.e(7046).then(n.bind(n, 7046)),
          },
          {
            id: 'po',
            name: 'Gettext PO',
            aliases: ['pot', 'potx'],
            import: () => n.e(3155).then(n.bind(n, 3155)),
          },
          {
            id: 'polar',
            name: 'Polar',
            import: () => n.e(8106).then(n.bind(n, 8106)),
          },
          {
            id: 'postcss',
            name: 'PostCSS',
            import: () => n.e(7382).then(n.bind(n, 5001)),
          },
          {
            id: 'powerquery',
            name: 'PowerQuery',
          ...
          },
          {
            id: 'prisma',
            name: 'Prisma',
            import: () => n.e(5536).then(n.bind(n, 5536)),
          },
          {
            id: 'prolog',
            name: 'Prolog',
            import: () => n.e(6769).then(n.bind(n, 6769)),
          },
          {
            id: 'proto',
          ...
          },
          {
            ...
            aliases: ['jade'],
            import: () =>
              Promise.all([n.e(6705), n.e(3939), n.e(947), n.e(6542)]).then(
                n.bind(n, 6542)
              ),
          },
          {
            id: 'puppet',
            name: 'Puppet',
            import: () => n.e(7618).then(n.bind(n, 7618)),
          },
          {
            id: 'purescript',
            name: 'PureScript',
            import: () => n.e(6471).then(n.bind(n, 6471)),
          },
          {
            id: 'python',
            name: 'Python',
            aliases: ['py'],
            import: () => n.e(3034).then(n.bind(n, 3034)),
          },
          {
            id: 'qml',
            name: 'QML',
            import: () =>
              Promise.all([n.e(6705), n.e(4196)]).then(n.bind(n, 4196)),
          },
          {
            id: 'qmldir',
            name: 'QML Directory',
            import: () => n.e(8927).then(n.bind(n, 8927)),
          },
          {
            id: 'qss',
            name: 'Qt Style Sheets',
            import: () => n.e(9961).then(n.bind(n, 9961)),
          },
          { id: 'r', name: 'R', import: () => n.e(6588).then(n.bind(n, 6588)) },
          {
            id: 'racket',
            name: 'Racket',
            import: () => n.e(6430).then(n.bind(n, 6430)),
          },
          {
            id: 'raku',
            name: 'Raku',
            aliases: ['perl6'],
            import: () => n.e(4643).then(n.bind(n, 4643)),
          },
          {
            id: 'razor',
            name: 'ASP.NET Razor',
          ...
          },
          {
            ...
            import: () => n.e(9516).then(n.bind(n, 9516)),
          },
          {
            id: 'regexp',
            name: 'RegExp',
            aliases: ['regex'],
            import: () => n.e(9003).then(n.bind(n, 9003)),
          },
          {
            id: 'rel',
            name: 'Rel',
            import: () => n.e(2151).then(n.bind(n, 2151)),
          },
          {
            id: 'riscv',
            name: 'RISC-V',
            import: () => n.e(7911).then(n.bind(n, 7911)),
          },
          {
            id: 'rst',
          ...
          },
          {
            ...
            name: 'Rust',
            aliases: ['rs'],
            import: () => n.e(850).then(n.bind(n, 850)),
          },
          {
            id: 'sas',
            name: 'SAS',
            import: () =>
              Promise.all([n.e(9754), n.e(9309)]).then(n.bind(n, 9309)),
          },
          {
            id: 'sass',
            name: 'Sass',
            import: () => n.e(7938).then(n.bind(n, 7938)),
          },
          {
            id: 'scala',
            name: 'Scala',
            import: () => n.e(2140).then(n.bind(n, 2140)),
          },
          {
            id: 'scheme',
            name: 'Scheme',
            import: () => n.e(161).then(n.bind(n, 161)),
          },
          {
            id: 'scss',
            name: 'SCSS',
            import: () =>
              Promise.all([n.e(3939), n.e(232)]).then(n.bind(n, 232)),
          },
          {
            id: 'sdbl',
            name: '1C (Query)',
            aliases: ['1c-query'],
            import: () => n.e(7423).then(n.bind(n, 7423)),
          },
          {
            id: 'shaderlab',
            name: 'ShaderLab',
            aliases: ['shader'],
            import: () => n.e(890).then(n.bind(n, 890)),
          },
          {
            id: 'shellscript',
            name: 'Shell',
          ...
          },
          {
            ...
            aliases: ['console'],
            import: () =>
              Promise.all([n.e(7917), n.e(5582)]).then(n.bind(n, 5582)),
          },
          {
            id: 'smalltalk',
            name: 'Smalltalk',
            import: () => n.e(4113).then(n.bind(n, 4113)),
          },
          {
            id: 'solidity',
            name: 'Solidity',
            import: () => n.e(8827).then(n.bind(n, 8827)),
          },
          {
            id: 'soy',
            ...
            import: () =>
              Promise.all([n.e(6705), n.e(3939), n.e(947), n.e(8529)]).then(
                n.bind(n, 8529)
              ),
          },
          {
            id: 'sparql',
            name: 'SPARQL',
            import: () => n.e(5107).then(n.bind(n, 5107)),
          },
          {
            id: 'splunk',
          ...
          },
          {
            id: 'sql',
            name: 'SQL',
            import: () => n.e(9754).then(n.bind(n, 9754)),
          },
          {
            id: 'ssh-config',
            name: 'SSH Config',
            import: () => n.e(353).then(n.bind(n, 353)),
          },
          {
            id: 'stata',
            name: 'Stata',
            import: () =>
              Promise.all([n.e(9754), n.e(5473)]).then(n.bind(n, 5473)),
          },
          {
            id: 'stylus',
            name: 'Stylus',
            aliases: ['styl'],
            import: () => n.e(4978).then(n.bind(n, 2597)),
          },
          {
            id: 'svelte',
            name: 'Svelte',
            import: () =>
              Promise.all([n.e(6705), n.e(4402), n.e(3939), n.e(993)]).then(
                n.bind(n, 993)
              ),
          },
          {
            id: 'swift',
            name: 'Swift',
            import: () => n.e(8467).then(n.bind(n, 8467)),
          },
          {
            id: 'system-verilog',
            name: 'SystemVerilog',
            import: () => n.e(8234).then(n.bind(n, 8234)),
          },
          {
            id: 'systemd',
            name: 'Systemd Units',
            import: () => n.e(8075).then(n.bind(n, 8075)),
          },
          {
            id: 'talonscript',
            name: 'TalonScript',
            aliases: ['talon'],
            import: () => n.e(843).then(n.bind(n, 843)),
          },
          {
            id: 'tasl',
            name: 'Tasl',
            import: () => n.e(1640).then(n.bind(n, 1640)),
          },
          {
            id: 'tcl',
            name: 'Tcl',
          ...
          },
          {
            ...
            name: 'Templ',
            import: () =>
              Promise.all([n.e(6705), n.e(3939), n.e(6182), n.e(9800)]).then(
                n.bind(n, 9800)
              ),
          },
          {
          ...
          },
          {
            ...
            name: 'TeX',
            import: () =>
              Promise.all([n.e(6588), n.e(8557)]).then(n.bind(n, 8557)),
          },
          {
            id: 'toml',
            name: 'TOML',
            import: () => n.e(2068).then(n.bind(n, 2068)),
          },
          {
            id: 'ts-tags',
          ...
          },
          {
            id: 'tsv',
            name: 'TSV',
            import: () => n.e(1569).then(n.bind(n, 1569)),
          },
          {
            id: 'tsx',
            name: 'TSX',
            import: () => n.e(3824).then(n.bind(n, 3779)),
          },
          {
            id: 'turtle',
            name: 'Turtle',
            import: () => n.e(4066).then(n.bind(n, 4066)),
          },
          {
            id: 'twig',
            name: 'Twig',
          ...
          },
          {
            ...
            name: 'TypeScript',
            aliases: ['ts'],
            import: () => n.e(4402).then(n.bind(n, 6593)),
          },
          {
            id: 'typespec',
            name: 'TypeSpec',
            aliases: ['tsp'],
            import: () => n.e(9093).then(n.bind(n, 9093)),
          },
          {
            id: 'typst',
            name: 'Typst',
            aliases: ['typ'],
            import: () => n.e(6436).then(n.bind(n, 6436)),
          },
          { id: 'v', name: 'V', import: () => n.e(5611).then(n.bind(n, 5611)) },
          {
            id: 'vala',
            name: 'Vala',
            import: () => n.e(7218).then(n.bind(n, 7218)),
          },
          {
            id: 'vb',
            name: 'Visual Basic',
            aliases: ['cmd'],
            import: () => n.e(4344).then(n.bind(n, 4344)),
          },
          {
            id: 'verilog',
            name: 'Verilog',
            import: () => n.e(8300).then(n.bind(n, 8300)),
          },
          {
            id: 'vhdl',
            name: 'VHDL',
          ...
          },
          {
            ...
            name: 'Vyper',
            aliases: ['vy'],
            import: () => n.e(7786).then(n.bind(n, 7786)),
          },
          {
            id: 'wasm',
            name: 'WebAssembly',
            import: () => n.e(4156).then(n.bind(n, 1775)),
          },
          {
            id: 'wenyan',
            name: 'Wenyan',
            aliases: ['文言'],
            import: () => n.e(3646).then(n.bind(n, 3646)),
          },
          {
            id: 'wgsl',
            name: 'WGSL',
            import: () => n.e(6183).then(n.bind(n, 6183)),
          },
          {
            id: 'wikitext',
            name: 'Wikitext',
          ...
          },
          {
            ...
            import: () => n.e(8414).then(n.bind(n, 8414)),
          },
          {
            id: 'wolfram',
            name: 'Wolfram',
            aliases: ['wl'],
            import: () => n.e(8717).then(n.bind(n, 8434)),
          },
          {
            id: 'xml',
            name: 'XML',
            import: () =>
              Promise.all([n.e(2268), n.e(5634)]).then(n.bind(n, 3253)),
          },
          {
            id: 'xsl',
            name: 'XSL',
            import: () =>
              Promise.all([n.e(2268), n.e(7243)]).then(n.bind(n, 7243)),
          },
          {
            id: 'yaml',
            name: 'YAML',
            aliases: ['yml'],
            import: () => n.e(7221).then(n.bind(n, 7221)),
          },
          {
            id: 'zenscript',
            name: 'ZenScript',
            import: () => n.e(7480).then(n.bind(n, 7480)),
          },
          {
            id: 'zig',
            name: 'Zig',
            import: () => n.e(7808).then(n.bind(n, 7808)),
          },
        ],
        ns = Object.fromEntries(na.map((e) => [e.id, e.import])),
        nl = Object.fromEntries(
          na.flatMap((e) => e.aliases?.map((t) => [t, e.import]) || [])
        ),
        nu = { ...ns, ...nl },
        nc = Object.fromEntries(
          [
            ...
            },
            {
              ...
              type: 'dark',
              import: () => n.e(2009).then(n.bind(n, 2009)),
            },
            {
              id: 'ayu-dark',
              displayName: 'Ayu Dark',
              type: 'dark',
              import: () => n.e(7862).then(n.bind(n, 7862)),
            },
            {
            ...
            },
            {
              ...
              type: 'dark',
              import: () => n.e(3833).then(n.bind(n, 3833)),
            },
            {
              id: 'dracula',
            ...
            },
            {
              ...
              type: 'dark',
              import: () => n.e(1374).then(n.bind(n, 1374)),
            },
            {
              id: 'light-plus',
              displayName: 'Light Plus',
              type: 'light',
              import: () => n.e(111).then(n.bind(n, 111)),
            },
            {
              id: 'material-theme',
            ...
            },
            {
              ...
              type: 'dark',
              import: () => n.e(8595).then(n.bind(n, 8595)),
            },
            {
              id: 'min-light',
            ...
            },
            {
              ...
              displayName: 'Monokai',
              type: 'dark',
              import: () => n.e(3238).then(n.bind(n, 3238)),
            },
            {
              id: 'night-owl',
              displayName: 'Night Owl',
              type: 'dark',
              import: () => n.e(5139).then(n.bind(n, 5139)),
            },
            {
              id: 'nord',
              displayName: 'Nord',
              type: 'dark',
              import: () => n.e(6313).then(n.bind(n, 6313)),
            },
            {
              id: 'one-dark-pro',
            ...
            },
            {
              ...
              type: 'light',
              import: () => n.e(1399).then(n.bind(n, 1399)),
            },
            {
              id: 'plastic',
              displayName: 'Plastic',
              type: 'dark',
              import: () => n.e(5568).then(n.bind(n, 5568)),
            },
            {
              id: 'poimandres',
            ...
            },
            {
              ...
              displayName: 'Red',
              type: 'dark',
              import: () => n.e(589).then(n.bind(n, 589)),
            },
            {
              id: 'rose-pine',
            ...
            },
            {
              ...
              displayName: 'Vesper',
              type: 'dark',
              import: () => n.e(8161).then(n.bind(n, 8161)),
            },
            {
              id: 'vitesse-black',
            ...
            for (let r = 1; r <= 4; r *= 2) {
              ...
              if (
                ...
                (function (e) {
                  try {
                    return (
                      t.grow((e - n.byteLength + 65535) >>> 16), i(t.buffer), 1
                    );
                  } catch {}
                })(Math.min(0x80000000, nf(Math.max(e, a), 65536))))
              )
                return !0;
            }
            return !1;
        ...
        static _utf8ByteLength(e) {
          ...
          for (let n = 0, r = e.length; n < r; n++) {
            ...
            if (i >= 55296 && i <= 56319 && n + 1 < r) {
              ...
              t >= 56320 &&
                t <= 57343 &&
                ((o = (((i - 55296) << 10) + 65536) | (t - 56320)), (a = !0));
            }
            o <= 127
              ? (t += 1)
              : o <= 2047
      ...
      let nS = class e {
        constructor(t) {
          if (
            ...
            throw new nd('Must invoke loadWasm first.');
      ...
      nb(nS, 'LAST_ID', 0),
        nb(nS, '_sharedPtr', 0),
        nb(nS, '_sharedPtrInUse', !1);
      class nk {
        constructor(e) {
          if ((nb(this, '_onigBinding'), nb(this, '_ptr'), !n_))
            throw new nd('Must invoke loadWasm first.');
          let t = [],
            n = [];
          ...
          n_.ofree(i),
            ...
            0 === o &&
              (function (e) {
                throw new nd(e.UTF8ToString(e.getLastOnigError()));
              })(n_),
      ...
      async function nC(e) {
        return (
                    ...
                    if (
                      ...
                      n =
                        'function' == typeof WebAssembly.instantiateStreaming
                          ? await ((o = n),
                            (e) => WebAssembly.instantiateStreaming(o, e))(t)
                          : await ((a = n),
                            async (e) => {
          ...
          {
            createScanner: (e) =>
              new nk(e.map((e) => ('string' == typeof e ? e : e.source))),
      ...
      let { codeToHtml: nA } = (function (e, t) {
        let n,
          r = async function (t = {}) {
              ...
              }));
            {
              ...
              return (
                await Promise.all([
                  e.loadTheme(...(t.themes || [])),
                  e.loadLanguage(...(t.langs || [])),
                ]),
                e
              );
            }
        ...
        return {
          ...
          codeToTokensBase: async (e, t) =>
            (await i(e, t)).codeToTokensBase(e, t),
          codeToTokensWithThemes: async (e, t) =>
            (await i(e, t)).codeToTokensWithThemes(e, t),
          getLastGrammarState: async (e, t) =>
            (
              await r({ langs: [t.lang], themes: [t.theme] })
        ...
        (function (e) {
          ...
          themes: nc,
          engine: () =>
            nC(Promise.all([n.e(8093), n.e(410)]).then(n.bind(n, 410))),
        }),
        {
              ...
              (s.isBuffer = function (e) {
                ...
                (s.concat = function (e, t) {
                  ...
                  for (n = 0; n < e.length; ++n) {
                    var o = e[n];
                    if ((P(o, Uint8Array) && (o = s.from(o)), !s.isBuffer(o)))
                      throw TypeError(
                        '"list" argument must be an Array of Buffers'
                      );
              ...
              (s.prototype.write = function (e, t, n, r) {
                ...
                for (var p = !1; ; )
                  switch (r) {
                    ...
                    case 'utf-8':
                      return (
                        (i = t), (o = n), E(A(e, this.length - i), this, i, o)
                      );
                    case 'ascii':
    ...
    8809: (e, t, n) => {
      ...
      let p = N(Array.prototype.forEach),
        f = N(Array.prototype.lastIndexOf),
      ...
      var en = (function e() {
        ...
        let {
          ...
          e8 = E({}, ['annotation-xml']),
          e6 = E({}, ['title', 'style', 'font', 'a', 'script']),
          e4 = null,
            ...
            if (!te || te !== e) {
              if (
                ...
                (e7 =
                  ...
                  (e4 =
                    -1 === e9.indexOf(e.PARSER_MEDIA_TYPE)
                      ? 'text/html'
                      : e.PARSER_MEDIA_TYPE)
                    ? _
                    : b),
                ...
                (e2 = C(e, 'ALLOWED_NAMESPACES')
                  ? E({}, e.ALLOWED_NAMESPACES, _)
                  : e3),
                (eK = C(e, 'ADD_URI_SAFE_ATTR')
                  ? E(P(eX), e.ADD_URI_SAFE_ATTR, e7)
                  : eX),
                (eV = C(e, 'ADD_DATA_URI_TAGS')
                  ? E(P(eY), e.ADD_DATA_URI_TAGS, e7)
                  : eY),
                (eW = C(e, 'FORBID_CONTENTS')
                  ? E({}, e.FORBID_CONTENTS, e7)
                  : eq),
                (eT = C(e, 'FORBID_TAGS') ? E({}, e.FORBID_TAGS, e7) : P({})),
                (eN = C(e, 'FORBID_ATTR') ? E({}, e.FORBID_ATTR, e7) : P({})),
                ...
                e$ &&
                  ...
                  !0 === e$.svg && (E(eS, R), E(ew, j), E(ew, F)),
                  !0 === e$.svgFilters && (E(eS, O), E(ew, j), E(ew, F)),
                  !0 === e$.mathMl && (E(eS, M), E(ew, G), E(ew, F))),
                e.ADD_TAGS &&
                  (eS === ek && (eS = P(eS)), E(eS, e.ADD_TAGS, e7)),
                e.ADD_ATTR &&
                  (ew === eC && (ew = P(ew)), E(ew, e.ADD_ATTR, e7)),
                e.ADD_URI_SAFE_ATTR && E(eK, e.ADD_URI_SAFE_ATTR, e7),
                e.FORBID_CONTENTS &&
                  (eW === eq && (eW = P(eW)), E(eW, e.FORBID_CONTENTS, e7)),
                eH && (eS['#text'] = !0),
        ...
        let tf = function (e) {
            let t = null;
            if ((tp(eh.beforeSanitizeElements, e, null), th(e)))
              return ts(e), !0;
            let n = e7(e.nodeName);
            if (
              (tp(eh.uponSanitizeElement, e, { tagName: n, allowedTags: eS }),
              (eO &&
                e.hasChildNodes() &&
            ...
            return (e instanceof N && !ta(e)) ||
              ...
              : (eR &&
                  ...
                  e.textContent !== t &&
                    ...
                    (e.textContent = t))),
                tp(eh.afterSanitizeElements, e, null),
                !1);
          },
          tm = function (e, t, n) {
            if (eG && ('id' === t || 'name' === t) && (n in o || n in tt))
              return !1;
            if (eP && !eN[t] && A(em, t));
            else if (eE && A(eg, t));
            else if (!ew[t] || eN[t]) {
                ...
                !(
                  (tg(e) &&
                    ...
                    ((eA.attributeNameCheck instanceof RegExp &&
                      A(eA.attributeNameCheck, t)) ||
                      (eA.attributeNameCheck instanceof Function &&
                        eA.attributeNameCheck(t)))) ||
                  ('is' === t &&
                    eA.allowCustomizedBuiltInElements &&
                    ((eA.tagNameCheck instanceof RegExp &&
                      A(eA.tagNameCheck, n)) ||
          ...
          ty = function (e) {
            tp(eh.beforeSanitizeAttributes, e, null);
            let { attributes: n } = e;
            if (!n || th(e)) return;
            let r = {
                attrName: '',
            ...
            for (; o--; ) {
              ...
              if (
                ...
                tp(eh.uponSanitizeAttribute, e, r),
                (c = r.attrValue),
                eF &&
                  ('id' === u || 'name' === u) &&
                  (tl(a, e), (c = 'user-content-' + c)),
              ...
              if (c !== l)
                try {
                  s ? e.setAttributeNS(s, a, c) : e.setAttribute(a, c),
                    th(e) ? ts(e) : m(i.removed);
                } catch (t) {
                  tl(a, e);
                }
            }
            tp(eh.afterSanitizeAttributes, e, null);
          },
          tb = function e(t) {
            let n = null,
              r = tc(t);
            for (tp(eh.beforeSanitizeShadowDOM, t, null); (n = r.nextNode()); )
              tp(eh.uponSanitizeShadowNode, n, null),
                tf(n),
                ty(n),
                n.content instanceof u && e(n.content);
            tp(eh.afterSanitizeShadowDOM, t, null);
          };
        return (
          (i.sanitize = function (e) {
            let n =
              ...
              l = null;
            if (
              ((e1 = !e) && (e = '\x3c!--\x3e'), 'string' != typeof e && !td(e))
            )
            ...
            if (
              ...
              ((o = (r = tu('\x3c!----\x3e')).ownerDocument.importNode(e, !0))
                .nodeType === Z.element &&
                'BODY' === o.nodeName) ||
              'HTML' === o.nodeName
                ? (r = o)
              ...
              if (!eB && !eR && !eI && -1 === e.indexOf('<'))
                return t && ej ? t.createHTML(e) : e;
              if (!(r = tu(e))) return eB ? null : ej ? eo : '';
            }
            r && eD && ts(r.firstChild);
            let c = tc(ez ? e : r);
            for (; (s = c.nextNode()); )
              tf(s), ty(s), s.content instanceof u && tb(s.content);
            if (ez) return e;
            if (eB) {
              if (eU)
                for (l = el.call(r.ownerDocument); r.firstChild; )
                  l.appendChild(r.firstChild);
              else l = r;
              return (
                (ew.shadowroot || ew.shadowrootmode) && (l = ec.call(a, l, !0)),
                l
              );
            }
