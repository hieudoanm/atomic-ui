  ...
  [2182],
  {
    2182: (e, t, n) => {
      ...
      let ej = eB({
        ...
        e5 = ['cent', 'copy', 'divide', 'gt', 'lt', 'not', 'para', 'times'],
        e6 = {}.hasOwnProperty,
        e3 = {};
      for (r in e2) e6.call(e2, r) && (e3[e2[r]] = r);
      let e8 = /[^\dA-Za-z]/;
      function e4(e, t, n) {
        let r,
          i = (function (e, t, n) {
      ...
      function tj(e) {
        ...
        if ((e.color && (t.color = e.color), e.bgColor && (t['background-color'] = e.bgColor), e.fontStyle)) {
          ...
          let n = [];
          e.fontStyle & k.Underline && n.push('underline'),
            e.fontStyle & k.Strikethrough && n.push('line-through'),
          ...
          return (function (e, t, n) {
            ...
            return s.map((t) =>
              u.parse(t[0]).map((n) => {
                ...
                let a = k.None;
                return (
                  n.decorations.has('bold') && (a |= k.Bold),
                  n.decorations.has('italic') && (a |= k.Italic),
                  n.decorations.has('underline') && (a |= k.Underline),
                  n.decorations.has('strikethrough') && (a |= k.Strikethrough),
      ...
      function t2(e, t, n) {
        let r, i, a, s, l, u;
        if ('themes' in n) {
          let { defaultColor: h = 'light', cssVariablePrefix: c = '--shiki-' } = n,
            d = Object.entries(n.themes)
              .filter((e) => e[1])
              .map((e) => ({ color: e[0], theme: e[1] }))
              .sort((e, t) => (e.color === h ? -1 : +(t.color === h)));
          if (0 === d.length) throw new o('`themes` option must not be empty');
          let p = t1(e, t, n);
          if (((u = tW(p)), h && tG !== h && !d.find((e) => e.color === h)))
            throw new o(`\`themes\` option must contain the defaultColor key \`${h}\``);
          let m = d.map((t) => e.getTheme(t.theme)),
            f = d.map((e) => e.color);
          (a = p.map((e) =>
            e.map((e) =>
              (function (e, t, n, r) {
                let i = { content: e.content, explanation: e.explanation, offset: e.offset },
                  a = t.map((t) => tj(e.variants[t])),
                  s = new Set(a.flatMap((e) => Object.keys(e))),
                  l = {};
                return (
                  a.forEach((e, i) => {
                    for (let u of s) {
                      ...
                      if (0 === i && r)
                        if (r === tG && a.length > 1) {
                          ...
                          let h = a[e][u] || 'inherit',
                            c = a[r][u] || 'inherit';
                          l[u] = `light-dark(${h}, ${c})`;
                          let d = 'color' === u ? '' : 'background-color' === u ? '-bg' : `-${u}`;
                          l[n + t[i] + ('color' === u ? '' : d)] = s;
                        } else l[u] = s;
                      else {
                        let e = 'color' === u ? '' : 'background-color' === u ? '-bg' : `-${u}`;
                        l[n + t[i] + ('color' === u ? '' : e)] = s;
                      }
                    }
                  }),
      ...
      function t5(e, t, n, r, i, a) {
        return e
          .map((s, l) => {
            let u = tR(t[l][a], n[l]) || 'inherit',
              h = `${r + s.color}${'bg' === a ? '-bg' : ''}:${u}`;
            if (0 === l && i) {
              if (i === tG && e.length > 1) {
      ...
      function t6(
        ...
        t,
        n,
        r = { meta: {}, options: n, codeToHast: (t, n) => t6(e, t, n), codeToTokens: (t, n) => t2(e, t, n) }
      ) {
        let i = t;
            ...
            (a = a.map((e) => {
              ...
              for (let n of e) {
                ...
                let e = t[t.length - 1],
                  ...
                  a = e.fontStyle && (e.fontStyle & k.Underline || e.fontStyle & k.Strikethrough),
                  o = n.fontStyle && (n.fontStyle & k.Underline || n.fontStyle & k.Strikethrough);
      ...
      let t3 = function (e, t) {
        ...
        t8 = { light: '#333333', dark: '#bbbbbb' },
        t4 = { light: '#fffffe', dark: '#1e1e1e' },
        t9 = '__shiki_resolved';
      function t7(e) {
        if (e?.[t9]) return e;
        let t = { ...e };
        ...
        if (!n || !r) {
          ...
          e?.settings?.foreground && (r = e.settings.foreground),
            ...
            r || (r = 'light' === t.type ? t8.light : t8.dark),
            n || (n = 'light' === t.type ? t4.light : t4.dark),
            (t.fg = r),
            (t.bg = n);
        }
      ...
      async function ns(e) {
        ...
        return {
          ...
          codeToHtml: (e, n) =>
            (function (e, t, n) {
              let r = { meta: {}, options: n, codeToHast: (t, n) => t6(e, t, n), codeToTokens: (t, n) => t2(e, t, n) },
                i = t3(t6(e, t, n, r));
      ...
      let nl = [
          { id: 'abap', name: 'ABAP', import: () => n.e(3225).then(n.bind(n, 3225)) },
          { id: 'actionscript-3', name: 'ActionScript', import: () => n.e(2860).then(n.bind(n, 2860)) },
          { id: 'ada', name: 'Ada', import: () => n.e(4967).then(n.bind(n, 4967)) },
          {
            id: 'angular-html',
            name: 'Angular HTML',
            import: () => Promise.all([n.e(4065), n.e(2506), n.e(1084), n.e(7063)]).then(n.bind(n, 7063)),
          },
          {
            id: 'angular-ts',
            name: 'Angular TypeScript',
            import: () =>
              Promise.all([n.e(4065), n.e(1988), n.e(2506), n.e(1084), n.e(5591), n.e(6750)]).then(n.bind(n, 151)),
          },
          { id: 'apache', name: 'Apache Conf', import: () => n.e(8057).then(n.bind(n, 8057)) },
          { id: 'apex', name: 'Apex', import: () => n.e(551).then(n.bind(n, 551)) },
          {
            id: 'apl',
            name: 'APL',
            import: () => Promise.all([n.e(4065), n.e(2506), n.e(1084), n.e(1955), n.e(7882)]).then(n.bind(n, 7882)),
          },
          { id: 'applescript', name: 'AppleScript', import: () => n.e(9966).then(n.bind(n, 9966)) },
          { id: 'ara', name: 'Ara', import: () => n.e(3045).then(n.bind(n, 3045)) },
          { id: 'asciidoc', name: 'AsciiDoc', aliases: ['adoc'], import: () => n.e(2618).then(n.bind(n, 2618)) },
          { id: 'asm', name: 'Assembly', import: () => n.e(3042).then(n.bind(n, 3042)) },
          {
            id: 'astro',
            name: 'Astro',
            import: () => Promise.all([n.e(4065), n.e(2833), n.e(2506), n.e(4050)]).then(n.bind(n, 4050)),
          },
          { id: 'awk', name: 'AWK', import: () => n.e(5060).then(n.bind(n, 5060)) },
          { id: 'ballerina', name: 'Ballerina', import: () => n.e(651).then(n.bind(n, 651)) },
          { id: 'bat', name: 'Batch File', aliases: ['batch'], import: () => n.e(4990).then(n.bind(n, 4990)) },
          { id: 'beancount', name: 'Beancount', import: () => n.e(2224).then(n.bind(n, 2224)) },
          { id: 'berry', name: 'Berry', aliases: ['be'], import: () => n.e(7355).then(n.bind(n, 7355)) },
          { id: 'bibtex', name: 'BibTeX', import: () => n.e(2349).then(n.bind(n, 2349)) },
          { id: 'bicep', name: 'Bicep', import: () => n.e(2994).then(n.bind(n, 2994)) },
          {
            id: 'blade',
            name: 'Blade',
            import: () =>
              Promise.all([n.e(4065), n.e(2506), n.e(1084), n.e(1955), n.e(4903), n.e(7041)]).then(n.bind(n, 7041)),
          },
          { id: 'bsl', name: '1C (Enterprise)', aliases: ['1c'], import: () => n.e(3816).then(n.bind(n, 3816)) },
          { id: 'c', name: 'C', import: () => n.e(8352).then(n.bind(n, 8352)) },
          { id: 'cadence', name: 'Cadence', aliases: ['cdc'], import: () => n.e(9678).then(n.bind(n, 4440)) },
          { id: 'cairo', name: 'Cairo', import: () => Promise.all([n.e(1433), n.e(4303)]).then(n.bind(n, 4303)) },
          { id: 'clarity', name: 'Clarity', import: () => n.e(3127).then(n.bind(n, 3127)) },
          { id: 'clojure', name: 'Clojure', aliases: ['clj'], import: () => n.e(3319).then(n.bind(n, 3319)) },
          { id: 'cmake', name: 'CMake', import: () => n.e(4086).then(n.bind(n, 4086)) },
          {
            id: 'cobol',
            name: 'COBOL',
            import: () => Promise.all([n.e(4065), n.e(2506), n.e(1084), n.e(1955), n.e(6990)]).then(n.bind(n, 6990)),
          },
          { id: 'codeowners', name: 'CODEOWNERS', import: () => n.e(6268).then(n.bind(n, 6268)) },
          { id: 'codeql', name: 'CodeQL', aliases: ['ql'], import: () => n.e(5483).then(n.bind(n, 5483)) },
          {
            id: 'coffee',
            name: 'CoffeeScript',
            aliases: ['coffeescript'],
            import: () => Promise.all([n.e(4065), n.e(7103)]).then(n.bind(n, 7103)),
          },
          { id: 'common-lisp', name: 'Common Lisp', aliases: ['lisp'], import: () => n.e(2611).then(n.bind(n, 2611)) },
          { id: 'coq', name: 'Coq', import: () => n.e(1320).then(n.bind(n, 1320)) },
          {
            id: 'cpp',
            name: 'C++',
            aliases: ['c++'],
            import: () => Promise.all([n.e(3813), n.e(3514), n.e(4903), n.e(8352), n.e(7986)]).then(n.bind(n, 1464)),
          },
          {
            id: 'crystal',
            name: 'Crystal',
            import: () =>
              Promise.all([n.e(4065), n.e(2506), n.e(1084), n.e(4903), n.e(8352), n.e(5280), n.e(2945)]).then(
                n.bind(n, 2945)
              ),
          },
          { id: 'csharp', name: 'C#', aliases: ['c#', 'cs'], import: () => n.e(9294).then(n.bind(n, 9294)) },
          { id: 'css', name: 'CSS', import: () => n.e(2506).then(n.bind(n, 2506)) },
          { id: 'csv', name: 'CSV', import: () => n.e(6211).then(n.bind(n, 6211)) },
          { id: 'cue', name: 'CUE', import: () => n.e(4662).then(n.bind(n, 4662)) },
          { id: 'cypher', name: 'Cypher', aliases: ['cql'], import: () => n.e(9106).then(n.bind(n, 9106)) },
          { id: 'd', name: 'D', import: () => n.e(5655).then(n.bind(n, 5655)) },
          { id: 'dart', name: 'Dart', import: () => n.e(720).then(n.bind(n, 720)) },
          { id: 'dax', name: 'DAX', import: () => n.e(6607).then(n.bind(n, 2636)) },
          { id: 'desktop', name: 'Desktop', import: () => n.e(3499).then(n.bind(n, 3499)) },
          { id: 'diff', name: 'Diff', import: () => n.e(52).then(n.bind(n, 5290)) },
          { id: 'docker', name: 'Dockerfile', aliases: ['dockerfile'], import: () => n.e(1367).then(n.bind(n, 1367)) },
          { id: 'dotenv', name: 'dotEnv', import: () => n.e(1745).then(n.bind(n, 1745)) },
          { id: 'dream-maker', name: 'Dream Maker', import: () => n.e(2749).then(n.bind(n, 2749)) },
          {
            id: 'edge',
            name: 'Edge',
            import: () => Promise.all([n.e(4065), n.e(2833), n.e(2506), n.e(1084), n.e(1076)]).then(n.bind(n, 1076)),
          },
          {
            id: 'elixir',
            name: 'Elixir',
            import: () => Promise.all([n.e(4065), n.e(2506), n.e(1084), n.e(110)]).then(n.bind(n, 110)),
          },
          { id: 'elm', name: 'Elm', import: () => Promise.all([n.e(8352), n.e(2119)]).then(n.bind(n, 2119)) },
          { id: 'emacs-lisp', name: 'Emacs Lisp', aliases: ['elisp'], import: () => n.e(3465).then(n.bind(n, 1225)) },
          {
            id: 'erb',
            name: 'ERB',
            import: () =>
          ...
          { id: 'erlang', name: 'Erlang', aliases: ['erl'], import: () => n.e(2818).then(n.bind(n, 2818)) },
          { id: 'fennel', name: 'Fennel', import: () => n.e(7991).then(n.bind(n, 7991)) },
          { id: 'fish', name: 'Fish', import: () => n.e(4649).then(n.bind(n, 4649)) },
          { id: 'fluent', name: 'Fluent', aliases: ['ftl'], import: () => n.e(953).then(n.bind(n, 953)) },
          {
            id: 'fortran-fixed-form',
            name: 'Fortran (Fixed Form)',
            aliases: ['f', 'for', 'f77'],
            import: () => Promise.all([n.e(8591), n.e(1526)]).then(n.bind(n, 9145)),
          },
          {
          ...
          },
          {
            ...
            name: 'F#',
            aliases: ['f#', 'fs'],
            import: () => Promise.all([n.e(2360), n.e(6977)]).then(n.bind(n, 6977)),
          },
          { id: 'gdresource', name: 'GDResource', import: () => n.e(6874).then(n.bind(n, 6874)) },
          { id: 'gdscript', name: 'GDScript', import: () => n.e(8983).then(n.bind(n, 8983)) },
          { id: 'gdshader', name: 'GDShader', import: () => n.e(6725).then(n.bind(n, 6725)) },
          { id: 'genie', name: 'Genie', import: () => n.e(9543).then(n.bind(n, 9543)) },
          { id: 'gherkin', name: 'Gherkin', import: () => n.e(9029).then(n.bind(n, 9029)) },
          { id: 'git-commit', name: 'Git Commit Message', import: () => n.e(797).then(n.bind(n, 797)) },
          {
            id: 'git-rebase',
            name: 'Git Rebase Message',
            import: () => Promise.all([n.e(5280), n.e(1894)]).then(n.bind(n, 1894)),
          },
          { id: 'gleam', name: 'Gleam', import: () => n.e(7543).then(n.bind(n, 7543)) },
          {
            id: 'glimmer-js',
            name: 'Glimmer JS',
            aliases: ['gjs'],
            import: () => Promise.all([n.e(4065), n.e(2833), n.e(2506), n.e(1084), n.e(7640)]).then(n.bind(n, 7640)),
          },
          {
            id: 'glimmer-ts',
            name: 'Glimmer TS',
            aliases: ['gts'],
            import: () => Promise.all([n.e(4065), n.e(2833), n.e(2506), n.e(1084), n.e(3726)]).then(n.bind(n, 3726)),
          },
          { id: 'glsl', name: 'GLSL', import: () => Promise.all([n.e(8352), n.e(5919)]).then(n.bind(n, 5919)) },
          { id: 'gnuplot', name: 'Gnuplot', import: () => n.e(678).then(n.bind(n, 678)) },
          { id: 'go', name: 'Go', import: () => n.e(6469).then(n.bind(n, 6469)) },
          {
            id: 'graphql',
            name: 'GraphQL',
            aliases: ['gql'],
            import: () => Promise.all([n.e(4065), n.e(2833), n.e(9528), n.e(6205), n.e(2e3)]).then(n.bind(n, 9619)),
          },
          { id: 'groovy', name: 'Groovy', import: () => n.e(6169).then(n.bind(n, 6169)) },
          {
            id: 'hack',
            name: 'Hack',
            import: () => Promise.all([n.e(4065), n.e(2506), n.e(1084), n.e(4903), n.e(2680)]).then(n.bind(n, 2680)),
          },
          {
            id: 'haml',
            name: 'Ruby Haml',
            import: () => Promise.all([n.e(4065), n.e(2506), n.e(8177)]).then(n.bind(n, 8177)),
          },
          {
            id: 'handlebars',
            name: 'Handlebars',
            aliases: ['hbs'],
            import: () => Promise.all([n.e(4065), n.e(2506), n.e(1084), n.e(6975)]).then(n.bind(n, 6975)),
          },
          { id: 'haskell', name: 'Haskell', aliases: ['hs'], import: () => n.e(6711).then(n.bind(n, 6711)) },
          { id: 'haxe', name: 'Haxe', import: () => n.e(7015).then(n.bind(n, 7015)) },
          { id: 'hcl', name: 'HashiCorp HCL', import: () => n.e(8354).then(n.bind(n, 8354)) },
          { id: 'hjson', name: 'Hjson', import: () => n.e(6633).then(n.bind(n, 6633)) },
          { id: 'hlsl', name: 'HLSL', import: () => n.e(9774).then(n.bind(n, 9774)) },
          {
            id: 'html',
            name: 'HTML',
            import: () => Promise.all([n.e(4065), n.e(2506), n.e(1084)]).then(n.bind(n, 1084)),
          },
          {
            id: 'html-derivative',
            name: 'HTML (Derivative)',
            import: () => Promise.all([n.e(4065), n.e(2506), n.e(1084), n.e(6504)]).then(n.bind(n, 6504)),
          },
          {
            id: 'http',
            name: 'HTTP',
            import: () =>
              Promise.all([n.e(4065), n.e(2833), n.e(9528), n.e(6205), n.e(1955), n.e(5280), n.e(2e3), n.e(363)]).then(
                n.bind(n, 363)
              ),
          },
          { id: 'hxml', name: 'HXML', import: () => n.e(5344).then(n.bind(n, 5344)) },
          { id: 'hy', name: 'Hy', import: () => n.e(5934).then(n.bind(n, 5934)) },
          { id: 'imba', name: 'Imba', import: () => n.e(5238).then(n.bind(n, 5238)) },
          { id: 'ini', name: 'INI', aliases: ['properties'], import: () => n.e(4169).then(n.bind(n, 4169)) },
          { id: 'java', name: 'Java', import: () => n.e(1955).then(n.bind(n, 1955)) },
          { id: 'javascript', name: 'JavaScript', aliases: ['js'], import: () => n.e(4065).then(n.bind(n, 5390)) },
          {
            id: 'jinja',
            name: 'Jinja',
            import: () => Promise.all([n.e(4065), n.e(2506), n.e(1084), n.e(1605)]).then(n.bind(n, 1605)),
          },
          { id: 'jison', name: 'Jison', import: () => Promise.all([n.e(4065), n.e(382)]).then(n.bind(n, 382)) },
          { id: 'json', name: 'JSON', import: () => n.e(1129).then(n.bind(n, 1129)) },
          { id: 'json5', name: 'JSON5', import: () => n.e(4948).then(n.bind(n, 4948)) },
          { id: 'jsonc', name: 'JSON with Comments', import: () => n.e(9801).then(n.bind(n, 9801)) },
          ...
          { id: 'kotlin', name: 'Kotlin', aliases: ['kt', 'kts'], import: () => n.e(6476).then(n.bind(n, 6476)) },
          { id: 'kusto', name: 'Kusto', aliases: ['kql'], import: () => n.e(231).then(n.bind(n, 231)) },
          { id: 'latex', name: 'LaTeX', import: () => Promise.all([n.e(1237), n.e(71)]).then(n.bind(n, 71)) },
          { id: 'lean', name: 'Lean 4', aliases: ['lean4'], import: () => n.e(4075).then(n.bind(n, 4075)) },
          { id: 'less', name: 'Less', import: () => n.e(2824).then(n.bind(n, 2824)) },
          {
            id: 'liquid',
            name: 'Liquid',
            import: () => Promise.all([n.e(4065), n.e(2506), n.e(1084), n.e(243)]).then(n.bind(n, 243)),
          },
          { id: 'llvm', name: 'LLVM IR', import: () => n.e(7988).then(n.bind(n, 7988)) },
          { id: 'log', name: 'Log file', import: () => n.e(6697).then(n.bind(n, 6697)) },
          { id: 'logo', name: 'Logo', import: () => n.e(5906).then(n.bind(n, 5906)) },
          { id: 'lua', name: 'Lua', import: () => Promise.all([n.e(8352), n.e(8997)]).then(n.bind(n, 8997)) },
          { id: 'luau', name: 'Luau', import: () => n.e(1696).then(n.bind(n, 1696)) },
          { id: 'make', name: 'Makefile', aliases: ['makefile'], import: () => n.e(9857).then(n.bind(n, 2238)) },
          { id: 'markdown', name: 'Markdown', aliases: ['md'], import: () => n.e(2360).then(n.bind(n, 2360)) },
          {
            id: 'marko',
            name: 'Marko',
            import: () => Promise.all([n.e(4065), n.e(2506), n.e(5591), n.e(2824), n.e(6121)]).then(n.bind(n, 6121)),
          },
          { id: 'matlab', name: 'MATLAB', import: () => n.e(6384).then(n.bind(n, 6384)) },
          {
            id: 'mdc',
            name: 'MDC',
            import: () => Promise.all([n.e(4065), n.e(2506), n.e(1084), n.e(2360), n.e(8586)]).then(n.bind(n, 6205)),
          },
          { id: 'mdx', name: 'MDX', import: () => n.e(9158).then(n.bind(n, 9158)) },
          { id: 'mermaid', name: 'Mermaid', aliases: ['mmd'], import: () => n.e(7982).then(n.bind(n, 7982)) },
          { id: 'mipsasm', name: 'MIPS Assembly', aliases: ['mips'], import: () => n.e(7513).then(n.bind(n, 7513)) },
          { id: 'mojo', name: 'Mojo', import: () => n.e(78).then(n.bind(n, 78)) },
          { id: 'move', name: 'Move', import: () => n.e(7260).then(n.bind(n, 7260)) },
          { id: 'narrat', name: 'Narrat Language', aliases: ['nar'], import: () => n.e(6439).then(n.bind(n, 6439)) },
          { id: 'nextflow', name: 'Nextflow', aliases: ['nf'], import: () => n.e(7464).then(n.bind(n, 7464)) },
          { id: 'nginx', name: 'Nginx', import: () => Promise.all([n.e(8352), n.e(5975)]).then(n.bind(n, 5975)) },
          {
            id: 'nim',
            name: 'Nim',
            import: () =>
              Promise.all([n.e(4065), n.e(2506), n.e(1084), n.e(1955), n.e(8352), n.e(2360), n.e(2559)]).then(
                n.bind(n, 2559)
              ),
          },
          { id: 'nix', name: 'Nix', import: () => n.e(9470).then(n.bind(n, 9470)) },
          { id: 'nushell', name: 'nushell', aliases: ['nu'], import: () => n.e(6840).then(n.bind(n, 6840)) },
          { id: 'objective-c', name: 'Objective-C', aliases: ['objc'], import: () => n.e(9326).then(n.bind(n, 9326)) },
          { id: 'objective-cpp', name: 'Objective-C++', import: () => n.e(7890).then(n.bind(n, 2870)) },
          { id: 'ocaml', name: 'OCaml', import: () => n.e(5651).then(n.bind(n, 5651)) },
          { id: 'pascal', name: 'Pascal', import: () => n.e(8383).then(n.bind(n, 8383)) },
          {
            id: 'perl',
            name: 'Perl',
            import: () =>
              Promise.all([n.e(4065), n.e(2506), n.e(1084), n.e(1955), n.e(4903), n.e(5600)]).then(n.bind(n, 5600)),
          },
          {
            id: 'php',
            name: 'PHP',
            import: () =>
              Promise.all([n.e(4065), n.e(2506), n.e(1084), n.e(1955), n.e(4903), n.e(3035), n.e(8704)]).then(
                n.bind(n, 3035)
              ),
          },
          { id: 'plsql', name: 'PL/SQL', import: () => n.e(2419).then(n.bind(n, 2419)) },
          { id: 'po', name: 'Gettext PO', aliases: ['pot', 'potx'], import: () => n.e(3316).then(n.bind(n, 3316)) },
          { id: 'polar', name: 'Polar', import: () => n.e(9855).then(n.bind(n, 9855)) },
          { id: 'postcss', name: 'PostCSS', import: () => n.e(2568).then(n.bind(n, 2568)) },
          { id: 'powerquery', name: 'PowerQuery', import: () => n.e(4914).then(n.bind(n, 2533)) },
          { id: 'powershell', name: 'PowerShell', aliases: ['ps', 'ps1'], import: () => n.e(644).then(n.bind(n, 644)) },
          { id: 'prisma', name: 'Prisma', import: () => n.e(4367).then(n.bind(n, 4367)) },
          { id: 'prolog', name: 'Prolog', import: () => n.e(726).then(n.bind(n, 726)) },
          {
            id: 'proto',
            name: 'Protocol Buffer 3',
            aliases: ['protobuf'],
            import: () => n.e(6445).then(n.bind(n, 6445)),
          },
          {
            id: 'pug',
            name: 'Pug',
            aliases: ['jade'],
            import: () => Promise.all([n.e(4065), n.e(2506), n.e(1084), n.e(923)]).then(n.bind(n, 923)),
          },
          { id: 'puppet', name: 'Puppet', import: () => n.e(5925).then(n.bind(n, 5925)) },
          { id: 'purescript', name: 'PureScript', import: () => n.e(6972).then(n.bind(n, 6972)) },
          { id: 'python', name: 'Python', aliases: ['py'], import: () => n.e(1433).then(n.bind(n, 1433)) },
          { id: 'qml', name: 'QML', import: () => Promise.all([n.e(4065), n.e(6673)]).then(n.bind(n, 6673)) },
          { id: 'qmldir', name: 'QML Directory', import: () => n.e(992).then(n.bind(n, 992)) },
          { id: 'qss', name: 'Qt Style Sheets', import: () => n.e(6691).then(n.bind(n, 9072)) },
          { id: 'r', name: 'R', import: () => n.e(1237).then(n.bind(n, 1237)) },
          { id: 'racket', name: 'Racket', import: () => n.e(2238).then(n.bind(n, 4619)) },
          { id: 'raku', name: 'Raku', aliases: ['perl6'], import: () => n.e(3108).then(n.bind(n, 3108)) },
          {
            id: 'razor',
            name: 'ASP.NET Razor',
            import: () => Promise.all([n.e(4065), n.e(2506), n.e(1084), n.e(9294), n.e(3191)]).then(n.bind(n, 3191)),
          },
          { id: 'reg', name: 'Windows Registry Script', import: () => n.e(5353).then(n.bind(n, 5353)) },
          { id: 'regexp', name: 'RegExp', aliases: ['regex'], import: () => n.e(9348).then(n.bind(n, 9348)) },
          { id: 'rel', name: 'Rel', import: () => n.e(6050).then(n.bind(n, 6050)) },
          { id: 'riscv', name: 'RISC-V', import: () => n.e(1298).then(n.bind(n, 1298)) },
          {
            id: 'rst',
          ...
          { id: 'rust', name: 'Rust', aliases: ['rs'], import: () => n.e(1509).then(n.bind(n, 1509)) },
          { id: 'sas', name: 'SAS', import: () => Promise.all([n.e(4903), n.e(4776)]).then(n.bind(n, 4776)) },
          { id: 'sass', name: 'Sass', import: () => n.e(7917).then(n.bind(n, 7917)) },
          { id: 'scala', name: 'Scala', import: () => n.e(4013).then(n.bind(n, 4013)) },
          { id: 'scheme', name: 'Scheme', import: () => n.e(8170).then(n.bind(n, 8170)) },
          { id: 'scss', name: 'SCSS', import: () => Promise.all([n.e(2506), n.e(5591)]).then(n.bind(n, 5591)) },
          { id: 'sdbl', name: '1C (Query)', aliases: ['1c-query'], import: () => n.e(7032).then(n.bind(n, 7032)) },
          { id: 'shaderlab', name: 'ShaderLab', aliases: ['shader'], import: () => n.e(2667).then(n.bind(n, 2667)) },
          {
            id: 'shellscript',
            name: 'Shell',
            aliases: ['bash', 'sh', 'shell', 'zsh'],
            import: () => n.e(5280).then(n.bind(n, 5280)),
          },
          {
            id: 'shellsession',
            name: 'Shell Session',
            aliases: ['console'],
            import: () => Promise.all([n.e(5280), n.e(8749)]).then(n.bind(n, 8749)),
          },
          { id: 'smalltalk', name: 'Smalltalk', import: () => n.e(4116).then(n.bind(n, 4116)) },
          { id: 'solidity', name: 'Solidity', import: () => n.e(4056).then(n.bind(n, 4056)) },
          {
            id: 'soy',
            name: 'Closure Templates',
            aliases: ['closure-templates'],
            import: () => Promise.all([n.e(4065), n.e(2506), n.e(1084), n.e(4096)]).then(n.bind(n, 4096)),
          },
          { id: 'sparql', name: 'SPARQL', import: () => n.e(7728).then(n.bind(n, 7728)) },
          {
            id: 'splunk',
            name: 'Splunk Query Language',
            aliases: ['spl'],
            import: () => n.e(8326).then(n.bind(n, 8326)),
          },
          { id: 'sql', name: 'SQL', import: () => n.e(4903).then(n.bind(n, 4903)) },
          { id: 'ssh-config', name: 'SSH Config', import: () => n.e(7186).then(n.bind(n, 7186)) },
          { id: 'stata', name: 'Stata', import: () => Promise.all([n.e(4903), n.e(2704)]).then(n.bind(n, 2704)) },
          { id: 'stylus', name: 'Stylus', aliases: ['styl'], import: () => n.e(913).then(n.bind(n, 913)) },
          {
            id: 'svelte',
            name: 'Svelte',
            import: () => Promise.all([n.e(4065), n.e(2833), n.e(2506), n.e(3348)]).then(n.bind(n, 8586)),
          },
          { id: 'swift', name: 'Swift', import: () => n.e(54).then(n.bind(n, 54)) },
          { id: 'system-verilog', name: 'SystemVerilog', import: () => n.e(2969).then(n.bind(n, 2969)) },
          { id: 'systemd', name: 'Systemd Units', import: () => n.e(7730).then(n.bind(n, 7730)) },
          { id: 'talonscript', name: 'TalonScript', aliases: ['talon'], import: () => n.e(7746).then(n.bind(n, 7746)) },
          { id: 'tasl', name: 'Tasl', import: () => n.e(4683).then(n.bind(n, 4683)) },
          { id: 'tcl', name: 'Tcl', import: () => n.e(9638).then(n.bind(n, 9638)) },
          {
            id: 'templ',
            name: 'Templ',
            import: () => Promise.all([n.e(4065), n.e(2506), n.e(6469), n.e(6141)]).then(n.bind(n, 6141)),
          },
          {
            id: 'terraform',
            name: 'Terraform',
            aliases: ['tf', 'tfvars'],
            import: () => n.e(9811).then(n.bind(n, 9811)),
          },
          { id: 'tex', name: 'TeX', import: () => Promise.all([n.e(1237), n.e(6272)]).then(n.bind(n, 6272)) },
          { id: 'toml', name: 'TOML', import: () => n.e(7003).then(n.bind(n, 9384)) },
          {
            id: 'ts-tags',
          ...
          { id: 'tsv', name: 'TSV', import: () => n.e(7736).then(n.bind(n, 7736)) },
          { id: 'tsx', name: 'TSX', import: () => n.e(6205).then(n.bind(n, 6138)) },
          { id: 'turtle', name: 'Turtle', import: () => n.e(1665).then(n.bind(n, 1665)) },
          {
            id: 'twig',
            name: 'Twig',
            import: () =>
          ...
          { id: 'typescript', name: 'TypeScript', aliases: ['ts'], import: () => n.e(2833).then(n.bind(n, 4030)) },
          { id: 'typespec', name: 'TypeSpec', aliases: ['tsp'], import: () => n.e(6566).then(n.bind(n, 6566)) },
          { id: 'typst', name: 'Typst', aliases: ['typ'], import: () => n.e(3673).then(n.bind(n, 3673)) },
          { id: 'v', name: 'V', import: () => n.e(1593).then(n.bind(n, 1593)) },
          { id: 'vala', name: 'Vala', import: () => n.e(4177).then(n.bind(n, 4177)) },
          { id: 'vb', name: 'Visual Basic', aliases: ['cmd'], import: () => n.e(7283).then(n.bind(n, 7283)) },
          { id: 'verilog', name: 'Verilog', import: () => n.e(5290).then(n.bind(n, 2909)) },
          { id: 'vhdl', name: 'VHDL', import: () => n.e(2501).then(n.bind(n, 2501)) },
          {
            id: 'viml',
            name: 'Vim Script',
            aliases: ['vim', 'vimscript'],
            import: () => n.e(1003).then(n.bind(n, 1003)),
          },
          {
            id: 'vue',
            name: 'Vue',
            import: () => Promise.all([n.e(4065), n.e(2833), n.e(2506), n.e(1084), n.e(8951)]).then(n.bind(n, 8951)),
          },
          {
            id: 'vue-html',
            name: 'Vue HTML',
            import: () => Promise.all([n.e(4065), n.e(2833), n.e(2506), n.e(1084), n.e(6905)]).then(n.bind(n, 6905)),
          },
          { id: 'vyper', name: 'Vyper', aliases: ['vy'], import: () => n.e(5763).then(n.bind(n, 5763)) },
          { id: 'wasm', name: 'WebAssembly', import: () => n.e(4651).then(n.bind(n, 4651)) },
          { id: 'wenyan', name: 'Wenyan', aliases: ['文言'], import: () => n.e(3129).then(n.bind(n, 3129)) },
          { id: 'wgsl', name: 'WGSL', import: () => n.e(8960).then(n.bind(n, 8960)) },
          {
            id: 'wikitext',
            name: 'Wikitext',
            aliases: ['mediawiki', 'wiki'],
            import: () => n.e(1686).then(n.bind(n, 1686)),
          },
          { id: 'wit', name: 'WebAssembly Interface Types', import: () => n.e(7971).then(n.bind(n, 7971)) },
          { id: 'wolfram', name: 'Wolfram', aliases: ['wl'], import: () => n.e(7214).then(n.bind(n, 4211)) },
          { id: 'xml', name: 'XML', import: () => Promise.all([n.e(1955), n.e(6323)]).then(n.bind(n, 8704)) },
          { id: 'xsl', name: 'XSL', import: () => Promise.all([n.e(1955), n.e(146)]).then(n.bind(n, 146)) },
          { id: 'yaml', name: 'YAML', aliases: ['yml'], import: () => n.e(218).then(n.bind(n, 218)) },
          { id: 'zenscript', name: 'ZenScript', import: () => n.e(8441).then(n.bind(n, 8441)) },
          { id: 'zig', name: 'Zig', import: () => n.e(141).then(n.bind(n, 141)) },
        ],
          ...
          [
            {
              ...
              type: 'dark',
              import: () => n.e(6191).then(n.bind(n, 6191)),
            },
            { id: 'aurora-x', displayName: 'Aurora X', type: 'dark', import: () => n.e(8636).then(n.bind(n, 8636)) },
            { id: 'ayu-dark', displayName: 'Ayu Dark', type: 'dark', import: () => n.e(999).then(n.bind(n, 999)) },
            {
              id: 'catppuccin-frappe',
              displayName: 'Catppuccin Frapp\xe9',
              type: 'dark',
              import: () => n.e(5198).then(n.bind(n, 5198)),
            },
            {
              id: 'catppuccin-latte',
              displayName: 'Catppuccin Latte',
              type: 'light',
              import: () => n.e(4740).then(n.bind(n, 4740)),
            },
            {
              id: 'catppuccin-macchiato',
              displayName: 'Catppuccin Macchiato',
              type: 'dark',
              import: () => n.e(1203).then(n.bind(n, 1203)),
            },
            {
              id: 'catppuccin-mocha',
              displayName: 'Catppuccin Mocha',
              type: 'dark',
              import: () => n.e(736).then(n.bind(n, 736)),
            },
            { id: 'dark-plus', displayName: 'Dark Plus', type: 'dark', import: () => n.e(7830).then(n.bind(n, 7830)) },
            {
              id: 'dracula',
              displayName: 'Dracula Theme',
              type: 'dark',
              import: () => n.e(2901).then(n.bind(n, 2901)),
            },
            {
              id: 'dracula-soft',
              displayName: 'Dracula Theme Soft',
              type: 'dark',
              import: () => n.e(5048).then(n.bind(n, 5048)),
            },
            {
              id: 'everforest-dark',
              displayName: 'Everforest Dark',
              type: 'dark',
              import: () => n.e(4679).then(n.bind(n, 4679)),
            },
            {
              id: 'everforest-light',
              displayName: 'Everforest Light',
              type: 'light',
              import: () => n.e(1943).then(n.bind(n, 1943)),
            },
            {
              id: 'github-dark',
              displayName: 'GitHub Dark',
              type: 'dark',
              import: () => n.e(2821).then(n.bind(n, 2821)),
            },
            {
              id: 'github-dark-default',
              displayName: 'GitHub Dark Default',
              type: 'dark',
              import: () => n.e(9689).then(n.bind(n, 9689)),
            },
            {
              id: 'github-dark-dimmed',
              displayName: 'GitHub Dark Dimmed',
              type: 'dark',
              import: () => n.e(9072).then(n.bind(n, 3043)),
            },
            {
            ...
            },
            {
              ...
              type: 'light',
              import: () => n.e(2341).then(n.bind(n, 2341)),
            },
            {
              id: 'github-light-default',
              displayName: 'GitHub Light Default',
              type: 'light',
              import: () => n.e(8809).then(n.bind(n, 1190)),
            },
            {
              id: 'github-light-high-contrast',
              displayName: 'GitHub Light High Contrast',
              type: 'light',
              import: () => n.e(3149).then(n.bind(n, 3149)),
            },
            {
              id: 'gruvbox-dark-hard',
              displayName: 'Gruvbox Dark Hard',
              type: 'dark',
              import: () => n.e(3211).then(n.bind(n, 3211)),
            },
            {
              id: 'gruvbox-dark-medium',
              displayName: 'Gruvbox Dark Medium',
              type: 'dark',
              import: () => n.e(6881).then(n.bind(n, 6881)),
            },
            {
              id: 'gruvbox-dark-soft',
              displayName: 'Gruvbox Dark Soft',
              type: 'dark',
              import: () => n.e(9496).then(n.bind(n, 9496)),
            },
            {
              id: 'gruvbox-light-hard',
              displayName: 'Gruvbox Light Hard',
              type: 'light',
              import: () => n.e(9787).then(n.bind(n, 9787)),
            },
            {
            ...
            },
            {
              ...
              type: 'light',
              import: () => n.e(6632).then(n.bind(n, 6632)),
            },
            { id: 'houston', displayName: 'Houston', type: 'dark', import: () => n.e(7853).then(n.bind(n, 7853)) },
            {
              id: 'kanagawa-dragon',
              displayName: 'Kanagawa Dragon',
              type: 'dark',
              import: () => n.e(222).then(n.bind(n, 222)),
            },
            {
              id: 'kanagawa-lotus',
              displayName: 'Kanagawa Lotus',
              type: 'light',
              import: () => n.e(1042).then(n.bind(n, 1042)),
            },
            {
              id: 'kanagawa-wave',
              displayName: 'Kanagawa Wave',
              type: 'dark',
              import: () => n.e(1232).then(n.bind(n, 1232)),
            },
            { id: 'laserwave', displayName: 'LaserWave', type: 'dark', import: () => n.e(2861).then(n.bind(n, 2861)) },
            {
              id: 'light-plus',
              displayName: 'Light Plus',
              type: 'light',
              import: () => n.e(7470).then(n.bind(n, 7470)),
            },
            {
              id: 'material-theme',
            ...
            },
            {
              ...
              type: 'dark',
              import: () => n.e(9670).then(n.bind(n, 9670)),
            },
            {
              id: 'material-theme-lighter',
              displayName: 'Material Theme Lighter',
              type: 'light',
              import: () => n.e(1270).then(n.bind(n, 1270)),
            },
            {
              id: 'material-theme-ocean',
              displayName: 'Material Theme Ocean',
              type: 'dark',
              import: () => n.e(453).then(n.bind(n, 453)),
            },
            {
              id: 'material-theme-palenight',
              displayName: 'Material Theme Palenight',
              type: 'dark',
              import: () => n.e(1589).then(n.bind(n, 1589)),
            },
            { id: 'min-dark', displayName: 'Min Dark', type: 'dark', import: () => n.e(5442).then(n.bind(n, 5442)) },
            { id: 'min-light', displayName: 'Min Light', type: 'light', import: () => n.e(1136).then(n.bind(n, 8755)) },
            { id: 'monokai', displayName: 'Monokai', type: 'dark', import: () => n.e(2909).then(n.bind(n, 52)) },
            { id: 'night-owl', displayName: 'Night Owl', type: 'dark', import: () => n.e(5700).then(n.bind(n, 5700)) },
            { id: 'nord', displayName: 'Nord', type: 'dark', import: () => n.e(924).then(n.bind(n, 924)) },
            {
              id: 'one-dark-pro',
              displayName: 'One Dark Pro',
              type: 'dark',
              import: () => n.e(6508).then(n.bind(n, 6508)),
            },
            { id: 'one-light', displayName: 'One Light', type: 'light', import: () => n.e(200).then(n.bind(n, 200)) },
            { id: 'plastic', displayName: 'Plastic', type: 'dark', import: () => n.e(3607).then(n.bind(n, 3607)) },
            {
              id: 'poimandres',
              displayName: 'Poimandres',
              type: 'dark',
              import: () => n.e(1277).then(n.bind(n, 1277)),
            },
            { id: 'red', displayName: 'Red', type: 'dark', import: () => n.e(7350).then(n.bind(n, 7350)) },
            {
              id: 'rose-pine',
              displayName: 'Ros\xe9 Pine',
              type: 'dark',
              import: () => n.e(1535).then(n.bind(n, 1535)),
            },
            {
              id: 'rose-pine-dawn',
              displayName: 'Ros\xe9 Pine Dawn',
              type: 'light',
              import: () => n.e(5068).then(n.bind(n, 5068)),
            },
            {
              id: 'rose-pine-moon',
              displayName: 'Ros\xe9 Pine Moon',
              type: 'dark',
              import: () => n.e(9033).then(n.bind(n, 9033)),
            },
            {
              id: 'slack-dark',
              displayName: 'Slack Dark',
              type: 'dark',
              import: () => n.e(9054).then(n.bind(n, 9054)),
            },
            {
              id: 'slack-ochin',
              displayName: 'Slack Ochin',
              type: 'light',
              import: () => n.e(5111).then(n.bind(n, 5111)),
            },
            {
              id: 'snazzy-light',
              displayName: 'Snazzy Light',
              type: 'light',
              import: () => n.e(217).then(n.bind(n, 217)),
            },
            {
              id: 'solarized-dark',
              displayName: 'Solarized Dark',
              type: 'dark',
              import: () => n.e(1749).then(n.bind(n, 1749)),
            },
            {
              id: 'solarized-light',
              displayName: 'Solarized Light',
              type: 'light',
              import: () => n.e(8325).then(n.bind(n, 8325)),
            },
            {
              id: 'synthwave-84',
              displayName: "Synthwave '84",
              type: 'dark',
              import: () => n.e(5557).then(n.bind(n, 5557)),
            },
            {
              id: 'tokyo-night',
            ...
            { id: 'vesper', displayName: 'Vesper', type: 'dark', import: () => n.e(7252).then(n.bind(n, 7252)) },
            {
              id: 'vitesse-black',
              displayName: 'Vitesse Black',
              type: 'dark',
              import: () => n.e(6480).then(n.bind(n, 6480)),
            },
            {
              id: 'vitesse-dark',
              displayName: 'Vitesse Dark',
              type: 'dark',
              import: () => n.e(9145).then(n.bind(n, 1526)),
            },
            {
              id: 'vitesse-light',
              displayName: 'Vitesse Light',
              type: 'light',
              import: () => n.e(769).then(n.bind(n, 769)),
            },
          ].map((e) => [e.id, e.import])
        );
      ...
      var nb = Object.defineProperty,
        ...
        nk = (e, t, n) => n_(e, 'symbol' != typeof t ? t + '' : t, n);
      let nv = null;
      class nw {
        constructor(e) {
          nk(this, 'utf16Length'),
            ...
            nk(this, 'utf16Value'),
            nk(this, 'utf8Value'),
            nk(this, 'utf16OffsetToUtf8'),
            nk(this, 'utf8OffsetToUtf16');
          let t = e.length,
      ...
      let nS = class e {
        constructor(t) {
          if (
            (nk(this, 'id', ++e.LAST_ID),
            nk(this, '_onigBinding'),
            nk(this, 'content'),
            nk(this, 'utf16Length'),
            nk(this, 'utf8Length'),
            nk(this, 'utf16OffsetToUtf8'),
      ...
      nk(nS, 'LAST_ID', 0), nk(nS, '_sharedPtr', 0), nk(nS, '_sharedPtrInUse', !1);
      class nC {
        constructor(e) {
          if ((nk(this, '_onigBinding'), nk(this, '_ptr'), !nv)) throw new nm('Must invoke loadWasm first.');
          let t = [],
            n = [];
      ...
      let { codeToHtml: nN } = (function (e, t) {
        ...
        })({ langs: nc, themes: nd, engine: () => nP(Promise.all([n.e(3143), n.e(675)]).then(n.bind(n, 675))) }),
        {
            ...
            72: function (e, t, n) {
              ...
              (s.prototype.write = function (e, t, n, r) {
                ...
                (s.prototype.writeUInt8 = function (e, t, n) {
                  return (e *= 1), (t >>>= 0), n || k(this, e, t, 1, 255, 0), (this[t] = 255 & e), t + 1;
                }),
                ...
                (s.prototype.writeInt32LE = function (e, t, n) {
                  return (
                    (e *= 1),
                    (t >>>= 0),
                    n || k(this, e, t, 4, 0x7fffffff, -0x80000000),
                    (this[t] = 255 & e),
                    (this[t + 1] = e >>> 8),
                    (this[t + 2] = e >>> 16),
                    (this[t + 3] = e >>> 24),
