  ...
  [5031],
  {
    ...
    5031: (e, t, n) => {
      ...
      class tW {
        ...
        static initial(e, t) {
          return new tW(Object.fromEntries((Array.isArray(t) ? t : [t]).map((e) => [e, e_])), e);
        }
        constructor(...e) {
          if (2 === e.length) {
            let [t, n] = e;
      ...
      var tV = [
        ...
        tK = { 1: 'bold', 2: 'dim', 3: 'italic', 4: 'underline', 7: 'reverse', 8: 'hidden', 9: 'strikethrough' };
      function tY(e) {
        let t = e.shift();
        if ('2' === t) {
      ...
      function tJ(e, t, n = {}) {
                        ...
                        let e = (function (e) {
                          ...
                          for (; e.length > 0; ) {
                            ...
                            if (!Number.isNaN(r))
                              ...
                              else if (r <= 9) tK[r] && t.push({ type: 'setDecoration', value: tK[r] });
                              else if (r <= 29) {
                                let e = tK[r - 20];
                                e &&
        ...
        var u = t,
          ...
          p = n;
        let m = tQ(u, h, c, d, p),
          f = new tW(tQ(u, h, c, d, p).stateStack, h.name, c.name);
        return tF(m.tokens, f), m.tokens;
      }
      function tQ(e, t, n, r, i) {
        let a = tE(n, i),
          ...
          h = i.grammarState
            ? ((function (e, t) {
                if (!(e instanceof tW)) throw new o('Invalid grammar state');
      ...
      function t0(e, t, n) {
        let r = Object.entries(n.themes)
          ...
          s = i[0].state
            ? new tW(Object.fromEntries(i.map((e) => [e.theme, e.state?.getInternalStack(e.theme)])), i[0].state.lang)
            : void 0;
        return s && tF(o, s), o;
      }
      function t1(e, t, n) {
        ...
        if ('themes' in n) {
          ...
          let p = t0(e, t, n);
          if (((u = tH(p)), h && !d.find((e) => e.color === h)))
            ...
            e.map((e) =>
              (function (e, t, n, r) {
                let i = { content: e.content, explanation: e.explanation, offset: e.offset },
                  a = t.map((t) => tG(e.variants[t])),
                  o = new Set(a.flatMap((e) => Object.keys(e))),
                  s = {};
                return (
                  a.forEach((e, i) => {
                    for (let a of o) {
                      ...
                      if (0 === i && r) s[a] = o;
                        ...
                        let e = 'color' === a ? '' : 'background-color' === a ? '-bg' : `-${a}`;
                        s[n + t[i] + ('color' === a ? '' : e)] = o;
                      }
                    }
                  }),
          ...
          (i = d.map((e, t) => (0 === t && h ? '' : `${c + e.color}:`) + (tR(m[t].fg, g[t]) || 'inherit')).join(';')),
            (r = d
              .map((e, t) => (0 === t && h ? '' : `${c + e.color}-bg:`) + (tR(m[t].bg, g[t]) || 'inherit'))
              .join(';')),
          ...
          (r = tR(l.bg, o)), (i = tR(l.fg, o)), (s = l.name), (u = tH(a));
      ...
      function t2(
        ...
        let i = t;
        for (let e of tz(n)) i = e.preprocess?.call(r, i, n) || i;
        let { tokens: a, fg: o, bg: s, themeName: l, rootStyle: u, grammarState: h } = t1(e, i, n),
        ...
        for (let e of tz(n)) a = e.tokens?.call(p, a) || a;
        return (function (e, t, n, r = tH(e)) {
          let i = tz(t),
            a = [],
      ...
      async function t7(e) {
        return (await Promise.all(e.map(async (e) => (tB(e) ? null : t4(await tI(e)))))).filter((e) => !!e);
      }
      ...
      async function ni(e) {
        ...
        return (function (e) {
          ...
          let r = (e.langs || []).flat(1),
            ...
            a = new nt(new nn(e.engine, r), i, r, e.langAlias);
          function o(e) {
          ...
          getLastGrammarState: (...e) =>
            (function (...e) {
              ...
              let { theme: s, colorMap: l } = t.setTheme(a),
                u = t.getLanguage(i);
              return new tW(tQ(n, u, s, l, r).stateStack, u.name, s.name);
            })(t, ...e),
          ...
          codeToHtml: (e, n) =>
            (function (e, t, n) {
              let r = { meta: {}, options: n, codeToHast: (t, n) => t2(e, t, n), codeToTokens: (t, n) => t1(e, t, n) },
                i = t3(t2(e, t, n, r));
              for (let e of tz(n)) i = e.postprocess?.call(r, i, n) || i;
              return i;
            })(t, e, n),
          getBundledLanguages: () => ({}),
          getBundledThemes: () => ({}),
      ...
      let no = [
          ...
          { id: 'pascal', name: 'Pascal', import: () => n.e(2876).then(n.bind(n, 2876)) },
          {
            ...
            name: 'Perl',
            import: () =>
              Promise.all([n.e(6705), n.e(3939), n.e(947), n.e(2268), n.e(9754), n.e(1283)]).then(n.bind(n, 3664)),
          },
          {
            id: 'php',
            name: 'PHP',
        ...
        ns = Object.fromEntries(no.map((e) => [e.id, e.import])),
        nl = Object.fromEntries(no.flatMap((e) => e.aliases?.map((t) => [t, e.import]) || [])),
        nu = { ...ns, ...nl },
          ...
          emscripten_resize_heap: function (e) {
            ...
            for (let r = 1; r <= 4; r *= 2) {
              ...
              if (
                ...
                })(Math.min(0x80000000, nm(Math.max(e, o), 65536))))
              )
                return !0;
            }
            return !1;
      ...
      nb(nk, 'LAST_ID', 0), nb(nk, '_sharedPtr', 0), nb(nk, '_sharedPtrInUse', !1);
      class nw {
        constructor(e) {
          if ((nb(this, '_onigBinding'), nb(this, '_ptr'), !n_)) throw new nd('Must invoke loadWasm first.');
          let t = [],
            n = [];
          ...
          let a = n_.createOnigScanner(r, i, e.length);
                  ...
                  if (
                    ...
                    if (
                      ...
                      ('undefined' != typeof ArrayBuffer && (i instanceof ArrayBuffer || ArrayBuffer.isView(i))) ||
                        ...
                        ? (n = await nS(n)(t))
                        : 'default' in n && n.default instanceof WebAssembly.Module && (n = await nS(n.default)(t));
                  }
                  return 'instance' in n && (n = n.instance), 'exports' in n && (n = n.exports), n;
                });
              })()))),
          {
            createScanner: (e) => new nw(e.map((e) => ('string' == typeof e ? e : e.source))),
            createString: (e) => new nk(e),
          }
        );
      }
      let { codeToHtml: nA } = (function (e, t) {
        ...
        (function (e) {
          ...
          return async function (e) {
            ...
            let s = (e.themes ?? []).map((e) => a(e)),
              l = (e.langs ?? []).map((e) => i(e)),
              u = await na({ engine: e.engine ?? r(), ...e, themes: s, langs: l });
            return {
              ...u,
        ...
        })({ langs: nu, themes: nh, engine: () => nC(Promise.all([n.e(8093), n.e(410)]).then(n.bind(n, 410))) }),
        {
