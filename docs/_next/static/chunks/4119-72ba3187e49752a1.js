(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [4119],
  {
    6500: (e, t, n) => {
      ...
      var m = class {
        ...
        f = class {
            ...
            return this.createFromParsedTheme(
              (function (e) {
                ...
                for (let e = 0, i = t.length; e < i; e++) {
                  ...
                  let s = null;
                  'string' == typeof a.settings.foreground && d(a.settings.foreground) && (s = a.settings.foreground);
                  let l = null;
                  'string' == typeof a.settings.background && d(a.settings.background) && (l = a.settings.background);
                  for (let t = 0, a = i.length; t < a; t++) {
                    let a = i[t].trim().split(' '),
                      u = a[a.length - 1],
                      h = null;
                    (a.length > 1 && (h = a.slice(0, a.length - 1)).reverse(), (n[r++] = new b(u, h, e, o, s, l)));
                  }
                }
                return n;
              })(e),
          ...
          static createFromParsedTheme(e, t) {
            return (function (e, t) {
              e.sort((e, t) => {
                ...
                return 0 !== i || 0 !== (i = c(e.parentScopes, t.parentScopes)) ? i : e.index - t.index;
              });
              let n = 0,
                r = '#000000',
                i = '#ffffff';
              ...
              let a = new v(t),
                o = new y(n, a.getId(r), a.getId(i)),
                s = new S(new w(0, null, -1, 0, 0), []);
              for (let t = 0, n = e.length; t < n; t++) {
                let n = e[t];
          ...
          match(e) {
            ...
            return n ? new y(n.fontStyle, n.foreground, n.background) : null;
          }
        },
        g = class e {
          constructor(e, t) {
        ...
        S = class e {
          ...
          _doInsertHere(e, t, n, r, i) {
            ...
            for (let a = 0, o = this._rulesWithParentScopes.length; a < o; a++) {
              ...
              if (0 === c(o.parentScopes, t)) return void o.acceptOverwrite(e, n, r, i);
            }
          ...
          processQueue() {
            ...
            for (let n of e)
              !(function (e, t, n, r) {
                ...
                let a = n.lookup(t);
                e instanceof L
                  ? I({ baseGrammar: a, selfGrammar: i }, r)
      ...
      function O(e, t, n) {
        t.repository && t.repository[e] && M([t.repository[e]], t, n);
      }
      function I(e, t) {
        (e.selfGrammar.patterns &&
          Array.isArray(e.selfGrammar.patterns) &&
          M(e.selfGrammar.patterns, { ...e, repository: e.selfGrammar.repository }, t),
          e.selfGrammar.injections &&
            M(Object.values(e.selfGrammar.injections), { ...e, repository: e.selfGrammar.repository }, t));
      }
      function M(e, t, n) {
        for (let r of e) {
          ...
          Array.isArray(r.patterns) && M(r.patterns, { ...t, repository: e }, n);
          let i = r.include;
          if (!i) continue;
          let a = $(i);
          switch (a.kind) {
            case 0:
              I({ ...t, selfGrammar: t.baseGrammar }, n);
              break;
            case 1:
              I(t, n);
              break;
            ...
            case 4:
              ...
              if (o) {
                ...
                4 === a.kind ? O(a.ruleName, r, n) : I(r, n);
              } else 4 === a.kind ? n.add(new T(a.scopeName, a.ruleName)) : n.add(new L(a.scopeName));
          }
        }
      }
      var B = class {
      ...
      function $(e) {
        ...
        if ('$self' === e) return new D();
        let t = e.indexOf('#');
        return -1 === t ? new G(e) : 0 === t ? new U(e.substring(1)) : new j(e.substring(0, t), e.substring(t + 1));
      }
      var F = /\\(\d+)/,
        H = /\\(\d+)/g;
      Symbol('RuleId');
      var W = class {
        ...
        z = class extends W {
          ...
          _getCachedCompiledPatterns(e) {
            return (
              this._cachedCompiledPatterns ||
                ((this._cachedCompiledPatterns = new Q()), this.collectPatterns(e, this._cachedCompiledPatterns)),
              this._cachedCompiledPatterns
            );
          }
        },
        ...
        K = class extends W {
          ...
          _getCachedCompiledPatterns(e, t) {
            if (!this._cachedCompiledPatterns) {
              for (let t of ((this._cachedCompiledPatterns = new Q()), this.patterns))
        ...
        X = class extends W {
          ...
          _getCachedCompiledWhilePatterns(e, t) {
            return (
              this._cachedCompiledWhilePatterns ||
                ((this._cachedCompiledWhilePatterns = new Q()),
                ...
                n.registerRule((i) => {
                  ...
                  if (void 0 === t.begin) {
                    ...
                    return (
                      ...
                      new V(t.$vscodeTextmateLocation, t.id, t.name, t.contentName, e._compilePatterns(i, n, r))
                    );
                  }
                  return t.while
                    ? new X(
              ...
              for (let a = 0, o = t.length; a < o; a++) {
                ...
                if (-1 !== s) {
                  let e = n.getRule(s),
                    t = !1;
                  if (
                    ((e instanceof V || e instanceof K || e instanceof X) &&
        ...
        J = class e {
          ...
          constructor(e, t) {
            ...
            (this.hasAnchor ? (this._anchorCache = this._buildAnchorCache()) : (this._anchorCache = null),
              ...
              'string' == typeof this.source
                ? (this.hasBackReferences = F.test(this.source))
          ...
          resolveBackReferences(e, t) {
            ...
            return ((H.lastIndex = 0), this.source.replace(H, (e, t) => p(n[parseInt(t, 10)] || '')));
          }
          _buildAnchorCache() {
            let e, t, n, r;
            if ('string' != typeof this.source)
        ...
        et = class e {
          ...
          constructor(e, t) {
            ((this._defaultAttributes = new ee(e, 8)),
              (this._embeddedLanguagesMatcher = new en(Object.entries(t || {}))));
          }
          ...
          _getBasicScopeAttributes = new m((e) => new ee(this._scopeToLanguage(e), this._toStandardTokenType(e)));
          _scopeToLanguage(e) {
      ...
      function ei(e, t, n, r, i, a, o, s) {
            ...
            for (let p = s.pop(); p; p = s.pop()) {
              ...
              if (f) {
                ...
                f.captureIndices &&
                  ...
                  eo(e, t, n, p.stack, a, p.rule.whileCaptures, f.captureIndices),
        ...
        let c = Date.now();
        for (; !u; ) {
          if (0 !== s && Date.now() - c > s) return new er(i, !0);
          !(function () {
            let o = (function (e, t, n, r, i, a) {
              let o = (function (e, t, n, r, i, a) {
                  let { ruleScanner: o, findOptions: s } = ea(i.getRule(e), e, i.endRule, n, r === a),
              ...
              let l = (function (e, t, n, r, i, a, o) {
                ...
                for (let a = 0, d = e.length; a < d; a++) {
                  ...
                  let { ruleScanner: p, findOptions: m } = ea(t.getRule(d.ruleId), t, null, r, i === o),
            ...
            if (-1 === c) {
              ...
              if (((i = i.push(c, r, h, s[0].end === l, null, f, f)), o instanceof K)) {
                (eo(e, t, n, i, a, o.beginCaptures, s), a.produce(i, s[0].end), (h = s[0].end));
              ...
              } else if ((eo(e, t, n, i, a, o.captures, s), a.produce(i, s[0].end), (i = i.pop()), !d)) {
      ...
      function el(e, t, n, r, i) {
        let a = A(t, eu),
          o = Y.getCompiledRuleId(n, r, i.repository);
      ...
      var eh = class {
        constructor(e, t, n, r, i, a, o, s) {
          if (
            ...
            (this._onigLib = s),
            (this._basicScopeAttributesProvider = new et(n, r)),
            (this._rootId = -1),
            (this._lastRuleId = 0),
            ...
            for (let e of Object.keys(i))
              for (let t of A(e, eu)) this._tokenTypeMatchers.push({ matcher: t.matcher, type: i[e] });
        }
        _rootId;
        _lastRuleId;
        _ruleId2desc;
        ...
        _collectInjections() {
          ...
          if (n) {
            let r = n.injections;
            if (r) for (let t in r) el(e, t, r[t], this, n);
        ...
        getExternalGrammar(e, t) {
          ...
          if (this._grammarRepository) {
            ...
            if (n) return ((this._includedGrammars[e] = ec(n, t && t.$base)), this._includedGrammars[e]);
          }
        }
        ...
        _tokenize(e, t, n, r) {
          ...
          if (
            (-1 === this._rootId &&
              ((this._rootId = Y.getCompiledRuleId(this._grammar.repository.$self, this, this._grammar.repository)),
              this.getInjections()),
            t && t !== ep.NULL)
          )
            ((i = !1), t.reset());
            ...
            let n = this._basicScopeAttributesProvider.getDefaultAttributes(),
              ...
              a = C.set(0, n.languageId, n.tokenType, null, r.fontStyle, r.foregroundId, r.backgroundId),
              o = this.getRule(this._rootId).getName(null, null);
            ((e = o ? ed.createRootAndLookUpScopeName(o, a, this) : ed.createRoot('unknown', a)),
              (t = new ep(null, this._rootId, -1, -1, !1, null, e, e)));
          }
          e += '\n';
          let a = this.createOnigString(e),
            o = a.content.length,
            s = new ef(n, e, this._tokenTypeMatchers, this.balancedBracketSelectors),
            l = ei(this, a, i, 0, t, s, !0, r);
          return (x(a), { lineLength: o, lineTokens: s, ruleStack: l.stack, stoppedEarly: l.stoppedEarly });
        }
      };
      function ec(e, t) {
        return (
      ...
      var ed = class e {
          ...
          static fromExtension(t, n) {
            let r = t,
              i = t?.scopePath ?? null;
            for (let t of n) r = new e(r, (i = g.push(i, t.scopeNames)), t.encodedTokenAttributes);
            return r;
          }
          ...
          static mergeAttributes(e, t, n) {
            ...
            return (
              ...
              C.set(e, t.languageId, t.tokenType, null, r, i, a)
            );
          }
          pushAttributed(t, n) {
        ...
        em = class {
          ...
          constructor(e, t) {
            ((this.balancedBracketScopes = e.flatMap((e) =>
              '*' === e ? ((this.allowAny = !0), []) : A(e, eu).map((e) => e.matcher)
            )),
              (this.unbalancedBracketScopes = t.flatMap((e) => A(e, eu).map((e) => e.matcher))));
          }
          get matchesAlways() {
          ...
          produceFromScopes(e, t) {
            ...
            if (this._emitBinaryTokens) {
              ...
              if (
                ...
                for (let e of this._tokenTypeOverrides) e.matcher(t) && (n = C.set(n, 0, e.type, null, -1, 0, 0));
                this.balancedBracketSelectors && (r = this.balancedBracketSelectors.match(t));
              }
              if (
                (r && (n = C.set(n, 0, 8, r, -1, 0, 0)),
        ...
        eg = class {
          ...
          grammarForScopeName(e, t, n, r, i) {
            if (!this._grammars.has(e)) {
              ...
              if (!a) return null;
              this._grammars.set(e, new eh(e, a, t, n, r, i, this, this._onigLib));
            }
        ...
        ey = class {
          ...
          constructor(e) {
            ((this._options = e),
              (this._syncRegistry = new eg(f.createFromRawTheme(e.theme, e.colorMap), e.onigLib)),
          ...
          setTheme(e, t) {
            this._syncRegistry.setTheme(f.createFromRawTheme(e, t));
          }
          getColorMap() {
          ...
          loadGrammarWithConfiguration(e, t, n) {
            return this._loadGrammar(
              ...
              n.embeddedLanguages,
              n.tokenTypes,
              new em(n.balancedBracketSelectors || [], n.unbalancedBracketSelectors || [])
            );
          }
          loadGrammar(e) {
          ...
          _loadGrammar(e, t, n, r, i) {
            let a = new R(this._syncRegistry, e);
      ...
      ((ev.prototype.normal = {}), (ev.prototype.property = {}), (ev.prototype.space = void 0));
      class eS {
        constructor(e, t) {
          ((this.attribute = t), (this.property = e));
        }
      }
      ((eS.prototype.attribute = ''),
        (eS.prototype.booleanish = !1),
        (eS.prototype.boolean = !1),
        (eS.prototype.commaOrSpaceSeparated = !1),
        (eS.prototype.commaSeparated = !1),
        (eS.prototype.defined = !1),
        (eS.prototype.mustUseProperty = !1),
        (eS.prototype.number = !1),
        (eS.prototype.overloadedBoolean = !1),
        (eS.prototype.property = ''),
        (eS.prototype.spaceSeparated = !1),
        (eS.prototype.space = void 0));
      let eC = 0,
        eA = eR(),
        eP = eR(),
        eN = eR(),
      ...
      function eM(e) {
        ...
        for (let [r, i] of Object.entries(e.properties)) {
          let a = new eI(r, e.transform(e.attributes || {}, r), i, e.space);
          (e.mustUseProperty && e.mustUseProperty.includes(r) && (a.mustUseProperty = !0),
            (t[r] = a),
            (n[ew(r)] = r),
            (n[ew(a.attribute)] = r));
        }
        return new ev(t, n, e.space);
      }
      ...
      let eG = eM({
        ...
        eW = ek([eB, eG, e$, eF, eH], 'html'),
        eq = ek([eB, ej, e$, eF, eH], 'svg'),
        ez = {}.hasOwnProperty,
        eV = /["&'<>`]/g,
        eK = /[\uD800-\uDBFF][\uDC00-\uDFFF]/g,
        ...
        e5 = {}.hasOwnProperty,
        e8 = {};
      for (r in e1) e5.call(e1, r) && (e8[e1[r]] = r);
      let e4 = /[^\dA-Za-z]/;
      function e6(e, t, n) {
        let r,
          i = (function (e, t, n) {
            let r = '&#x' + e.toString(16).toUpperCase();
            return n && t && !eQ.test(String.fromCharCode(t)) ? r : r + ';';
              ...
              ? ((r = a.subset),
                (n = eJ.get(r)) ||
                  ((n = (function (e) {
                    let t = [],
                      n = -1;
                    for (; ++n < e.length; ) t.push(e[n].replace(eY, '\\$&'));
      ...
      let ts = /[ \t\n\f\r]/g;
      function tl(e) {
        return 'object' == typeof e ? 'text' === e.type && tu(e.value) : tu(e);
      }
      function tu(e) {
        return '' === e.replace(ts, '');
      }
      ...
      function tf(e) {
        return function (t, n, r) {
          return tm.call(e, t.tagName) && e[t.tagName](t, n, r);
        };
      }
      let tg = tf({
        body: function (e, t, n) {
      ...
      function ty(e, t, n) {
        let r = th(n, t, !0);
        return !r || ('comment' !== r.type && !('text' === r.type && tl(r.value.charAt(0))));
      }
      function tb(e, t, n) {
        let r = th(n, t);
      ...
      let tv = tf({
          body: function (e) {
            ...
            return (
              !t ||
              ('comment' !== t.type &&
                !('text' === t.type && tl(t.value.charAt(0))) &&
                ('element' !== t.type ||
                  ('meta' !== t.tagName &&
                    'link' !== t.tagName &&
                    'script' !== t.tagName &&
          ...
          colgroup: function (e, t, n) {
            let r = tc(n, t),
              i = th(e, -1, !0);
            return (
              !(n && r && 'element' === r.type && 'colgroup' === r.tagName && tg(r, n.children.indexOf(r), n)) &&
      ...
      function tS(e, t, n, r) {
        return n && 'element' === n.type && ('script' === n.tagName || 'style' === n.tagName)
          ? e.value
          : e7(e.value, Object.assign({}, r.settings.characterReferences, { subset: tw }));
      }
      let tC = (function (e, t) {
          let n = t || {};
          function r(t, ...n) {
          ...
          handlers: {
            comment: function (e, t, n, r) {
              return r.settings.bogusComments
                ? '<?' + e7(e.value, Object.assign({}, r.settings.characterReferences, { subset: e9 })) + '>'
                : '\x3c!--' +
                    e.value.replace(e3, function (e) {
                      return e7(e, Object.assign({}, r.settings.characterReferences, { subset: te }));
                    }) +
                    '--\x3e';
            },
            ...
            element: function (e, t, n, r) {
              let i,
                ...
                l = [];
              'html' === a.space && 'svg' === e.tagName && (r.schema = eq);
              let u = (function (e, t) {
                  let n,
                    r = [],
                    i = -1;
                        ...
                        let i = (function (e, t, n) {
                          let r,
                            i = (function (e, t) {
                              ...
                              if (n.length > 4 && 'data' === n.slice(0, 4) && ti.test(t)) {
                                if ('-' === t.charAt(4)) {
                                  let e = t.slice(5).replace(tr, to);
                                  r = 'data' + e.charAt(0).toUpperCase() + e.slice(1);
                                } else {
                                  let e = t.slice(4);
                                  if (!tr.test(e)) {
                                    let n = e.replace(tn, ta);
                          ...
                          let l = e7(
                            i.attribute,
                            Object.assign({}, e.settings.characterReferences, { subset: tk.name[a][o] })
                          );
                          return !0 === n ||
                            ((n = Array.isArray(n)
                              ? (i.commaSeparated
                            ...
                            : (e.settings.preferUnquoted &&
                                (r = e7(
                                  ...
                                  Object.assign({}, e.settings.characterReferences, {
                                    attribute: !0,
                                    subset: tk.unquoted[a][o],
                                  })
                                )),
                              r !== n &&
                                (e.settings.quoteSmart && tt(n, s) > tt(n, e.alternative) && (s = e.alternative),
                                (r =
                                  s +
                                  e7(
                                    n,
                                    Object.assign({}, e.settings.characterReferences, {
                                      subset: ("'" === s ? tk.single : tk.double)[a][o],
                                      attribute: !0,
                                    })
                                  ) +
                                  s)),
              ...
              return (
                ...
                (!u && o && tv(e, t, n)) ||
                  ...
                  l.push('>')),
                l.push(h),
                s || (o && tg(e, t, n)) || l.push('</' + e.tagName + '>'),
                l.join('')
              );
            },
            raw: function (e, t, n, r) {
              return r.settings.allowDangerousHtml ? e.value : tS(e, t, n, r);
            },
      ...
      let tU = 'light-dark()',
        tG = ['color', 'background-color'];
      function tj(e) {
        let t = {};
        if ((e.color && (t.color = e.color), e.bgColor && (t['background-color'] = e.bgColor), e.fontStyle)) {
          (e.fontStyle & _.Italic && (t['font-style'] = 'italic'), e.fontStyle & _.Bold && (t['font-weight'] = 'bold'));
          let n = [];
          (e.fontStyle & _.Underline && n.push('underline'),
            e.fontStyle & _.Strikethrough && n.push('line-through'),
      ...
      class tq {
        ...
        static initial(e, t) {
          return new tq(Object.fromEntries((Array.isArray(t) ? t : [t]).map((e) => [e, eb])), e);
        }
        constructor(...e) {
          if (2 === e.length) {
            let [t, n] = e;
                ...
                return i.length
                  ? n.map((e) =>
                      e.flatMap((e) => {
                        ...
                        return (
                          n < e.content.length && r.push({ ...e, content: e.content.slice(n), offset: e.offset + n }),
                          r
                        );
                      })
                    )
            ...
            code(e) {
              ...
              function i(e, t, n, i) {
                let s = r[e],
                  ...
                  h = -1;
                if (
                  (0 === t && (u = 0), 0 === n && (h = 0), n === 1 / 0 && (h = s.children.length), -1 === u || -1 === h)
                )
      ...
      var tK = [
        ...
        tX = { 1: 'bold', 2: 'dim', 3: 'italic', 4: 'underline', 7: 'reverse', 8: 'hidden', 9: 'strikethrough' };
      function tY(e) {
        let t = e.shift();
        if ('2' === t) {
      ...
      function tQ(e, t, n = {}) {
        ...
        if (tO(r) || tM(i)) return tD(t).map((e) => [{ content: e[0], offset: e[1] }]);
          ...
          return (function (e, t, n) {
                        ...
                        let e = (function (e) {
                          ...
                          for (; e.length > 0; ) {
                            ...
                            if (!Number.isNaN(r))
                              ...
                              else if (r <= 9) tX[r] && t.push({ type: 'setDecoration', value: tX[r] });
                              else if (r <= 29) {
                                let e = tX[r - 20];
                                e &&
            ...
            return s.map((t) =>
              u.parse(t[0]).map((n) => {
                ...
                let a = _.None;
                return (
                  n.decorations.has('bold') && (a |= _.Bold),
                  n.decorations.has('italic') && (a |= _.Italic),
                  n.decorations.has('underline') && (a |= _.Underline),
                  n.decorations.has('strikethrough') && (a |= _.Strikethrough),
      ...
      function t2(e, t, n) {
        ...
        if ('themes' in n) {
          ...
          let m = t1(e, t, n);
          if (((u = tW(m)), h && tU !== h && !p.find((e) => e.color === h)))
          ...
          ((r = tE(l.bg, o)), (i = tE(l.fg, o)), (s = l.name), (u = tW(a)));
      ...
      function t5(e, t, n, r, i, a, s) {
        return e
          .map((l, u) => {
            let h = tE(t[u][a], n[u]) || 'inherit',
            ...
            if (0 === u && i) {
              if (i === tU && e.length > 1) {
                ...
                let s = tE(t[r][a], n[r]) || 'inherit',
                  l = tE(t[i][a], n[i]) || 'inherit';
      ...
      function t8(
        ...
        t,
        n,
        r = { meta: {}, options: n, codeToHast: (t, n) => t8(e, t, n), codeToTokens: (t, n) => t2(e, t, n) }
      ) {
        let i = t;
        for (let e of tV(n)) i = e.preprocess?.call(r, i, n) || i;
        let { tokens: a, fg: o, bg: s, themeName: l, rootStyle: u, grammarState: h } = t2(e, i, n),
        ...
        (!0 === c
          ? (a = a.map((e) => {
              ...
              return (
                e.forEach((i, a) => {
                  let o = !(i.fontStyle && (i.fontStyle & _.Underline || i.fontStyle & _.Strikethrough));
            ...
            (a = a.map((e) => {
              ...
              for (let n of e) {
                ...
                let e = t[t.length - 1],
                  ...
                  a = e.fontStyle && (e.fontStyle & _.Underline || e.fontStyle & _.Strikethrough),
                  o = n.fontStyle && (n.fontStyle & _.Underline || n.fontStyle & _.Strikethrough);
      ...
      let t4 = function (e, t) {
          ...
          return {
            ...
            settings: {
              ...
              voids: n.voids || e_,
              characterReferences: n.characterReferences || tP,
        ...
        t6 = { light: '#333333', dark: '#bbbbbb' },
        t7 = { light: '#fffffe', dark: '#1e1e1e' },
        t3 = '__shiki_resolved';
      function t9(e) {
        if (e?.[t3]) return e;
        let t = { ...e };
        ...
        if (!n || !r) {
          ...
          (e?.settings?.foreground && (r = e.settings.foreground),
            ...
            r || (r = 'light' === t.type ? t6.light : t6.dark),
            n || (n = 'light' === t.type ? t7.light : t7.dark),
            (t.fg = r),
            (t.bg = n));
        }
        ...
        return (Object.defineProperty(t, t3, { enumerable: !1, writable: !1, value: !0 }), t);
      }
      async function ne(e) {
        return Array.from(
          new Set(
            (
              await Promise.all(
                e.filter((e) => !tI(e)).map(async (e) => await tR(e).then((e) => (Array.isArray(e) ? e : [e])))
              )
            ).flat()
          )
        );
      ...
      async function nt(e) {
        return (await Promise.all(e.map(async (e) => (tM(e) ? null : t9(await tR(e)))))).filter((e) => !!e);
      }
      ...
      class nr extends ey {
        ...
        setTheme(e) {
          ...
          (t || ((t = f.createFromRawTheme(e)), this._textmateThemeCache.set(e, t)), this._syncRegistry.setTheme(t));
        }
        getGrammar(e) {
          if (this._alias[e]) {
            let t = new Set([e]);
        ...
        return {
          getLastGrammarState: (...e) =>
            (function (...e) {
              ...
              if (tO(i) || tM(a)) throw new o('Plain language does not have grammar state');
          ...
          codeToTokens: (e, n) => t2(t, e, n),
          codeToHast: (e, n) => t8(t, e, n),
          codeToHtml: (e, n) =>
            (function (e, t, n) {
              let r = { meta: {}, options: n, codeToHast: (t, n) => t8(e, t, n), codeToTokens: (t, n) => t2(e, t, n) },
                i = t4(t8(e, t, n, r));
      ...
      let nl = [
          { id: 'abap', name: 'ABAP', import: () => n.e(2385).then(n.bind(n, 2385)) },
          { id: 'actionscript-3', name: 'ActionScript', import: () => n.e(2580).then(n.bind(n, 2580)) },
          { id: 'ada', name: 'Ada', import: () => n.e(6879).then(n.bind(n, 6879)) },
          {
            id: 'angular-html',
            name: 'Angular HTML',
            import: () => Promise.all([n.e(1950), n.e(1874), n.e(5572), n.e(6223)]).then(n.bind(n, 6223)),
          },
          {
            id: 'angular-ts',
            name: 'Angular TypeScript',
            import: () =>
              Promise.all([n.e(1950), n.e(6608), n.e(1874), n.e(5572), n.e(3583), n.e(2790)]).then(n.bind(n, 1151)),
          },
          { id: 'apache', name: 'Apache Conf', import: () => n.e(9745).then(n.bind(n, 9745)) },
          { id: 'apex', name: 'Apex', import: () => n.e(9247).then(n.bind(n, 9247)) },
          {
            id: 'apl',
            name: 'APL',
            import: () => Promise.all([n.e(1950), n.e(1874), n.e(5572), n.e(5771), n.e(1618)]).then(n.bind(n, 1618)),
          },
          { id: 'applescript', name: 'AppleScript', import: () => n.e(4406).then(n.bind(n, 4406)) },
          { id: 'ara', name: 'Ara', import: () => n.e(9629).then(n.bind(n, 9629)) },
          { id: 'asciidoc', name: 'AsciiDoc', aliases: ['adoc'], import: () => n.e(2130).then(n.bind(n, 2130)) },
          { id: 'asm', name: 'Assembly', import: () => n.e(8090).then(n.bind(n, 8090)) },
          {
            id: 'astro',
            name: 'Astro',
            import: () => Promise.all([n.e(1950), n.e(5215), n.e(5419), n.e(1874), n.e(4490)]).then(n.bind(n, 4490)),
          },
          { id: 'awk', name: 'AWK', import: () => n.e(4588).then(n.bind(n, 4588)) },
          { id: 'ballerina', name: 'Ballerina', import: () => n.e(5459).then(n.bind(n, 5459)) },
          { id: 'bat', name: 'Batch File', aliases: ['batch'], import: () => n.e(7430).then(n.bind(n, 7430)) },
          { id: 'beancount', name: 'Beancount', import: () => n.e(984).then(n.bind(n, 984)) },
          { id: 'berry', name: 'Berry', aliases: ['be'], import: () => n.e(5331).then(n.bind(n, 5331)) },
          { id: 'bibtex', name: 'BibTeX', import: () => n.e(3365).then(n.bind(n, 3365)) },
          { id: 'bicep', name: 'Bicep', import: () => n.e(2250).then(n.bind(n, 2250)) },
          {
            id: 'blade',
            name: 'Blade',
            import: () =>
              Promise.all([n.e(1950), n.e(1874), n.e(5572), n.e(5771), n.e(1647), n.e(5737)]).then(n.bind(n, 5737)),
          },
          { id: 'bsl', name: '1C (Enterprise)', aliases: ['1c'], import: () => n.e(7360).then(n.bind(n, 4979)) },
          { id: 'c', name: 'C', import: () => n.e(5208).then(n.bind(n, 5208)) },
          { id: 'cadence', name: 'Cadence', aliases: ['cdc'], import: () => n.e(2918).then(n.bind(n, 2918)) },
          { id: 'cairo', name: 'Cairo', import: () => Promise.all([n.e(7601), n.e(8951)]).then(n.bind(n, 8951)) },
          { id: 'clarity', name: 'Clarity', import: () => n.e(9407).then(n.bind(n, 9407)) },
          { id: 'clojure', name: 'Clojure', aliases: ['clj'], import: () => n.e(4684).then(n.bind(n, 2303)) },
          { id: 'cmake', name: 'CMake', import: () => n.e(5934).then(n.bind(n, 5934)) },
          {
            id: 'cobol',
            name: 'COBOL',
            import: () => Promise.all([n.e(1950), n.e(1874), n.e(5572), n.e(5771), n.e(9942)]).then(n.bind(n, 9942)),
          },
          { id: 'codeowners', name: 'CODEOWNERS', import: () => n.e(4852).then(n.bind(n, 4852)) },
          { id: 'codeql', name: 'CodeQL', aliases: ['ql'], import: () => n.e(6803).then(n.bind(n, 6803)) },
          {
            id: 'coffee',
            name: 'CoffeeScript',
            aliases: ['coffeescript'],
            import: () => Promise.all([n.e(1950), n.e(7255)]).then(n.bind(n, 7255)),
          },
          { id: 'common-lisp', name: 'Common Lisp', aliases: ['lisp'], import: () => n.e(635).then(n.bind(n, 635)) },
          { id: 'coq', name: 'Coq', import: () => n.e(9712).then(n.bind(n, 9712)) },
          {
            id: 'cpp',
            name: 'C++',
            aliases: ['c++'],
            import: () => Promise.all([n.e(3851), n.e(5076), n.e(1647), n.e(5208), n.e(2930)]).then(n.bind(n, 7120)),
          },
          {
            id: 'crystal',
            name: 'Crystal',
            import: () =>
              Promise.all([n.e(1950), n.e(1874), n.e(5572), n.e(1647), n.e(5208), n.e(4248), n.e(4665)]).then(
                n.bind(n, 4665)
              ),
          },
          { id: 'csharp', name: 'C#', aliases: ['c#', 'cs'], import: () => n.e(5545).then(n.bind(n, 7926)) },
          { id: 'css', name: 'CSS', import: () => n.e(1874).then(n.bind(n, 1874)) },
          { id: 'csv', name: 'CSV', import: () => n.e(6315).then(n.bind(n, 6315)) },
          { id: 'cue', name: 'CUE', import: () => n.e(1710).then(n.bind(n, 1710)) },
          { id: 'cypher', name: 'Cypher', aliases: ['cql'], import: () => n.e(4026).then(n.bind(n, 4026)) },
          { id: 'd', name: 'D', import: () => n.e(2703).then(n.bind(n, 2703)) },
          { id: 'dart', name: 'Dart', import: () => n.e(3080).then(n.bind(n, 3080)) },
          { id: 'dax', name: 'DAX', import: () => n.e(2724).then(n.bind(n, 2724)) },
          { id: 'desktop', name: 'Desktop', import: () => n.e(5747).then(n.bind(n, 5747)) },
          { id: 'diff', name: 'Diff', import: () => n.e(7938).then(n.bind(n, 7938)) },
          { id: 'docker', name: 'Dockerfile', aliases: ['dockerfile'], import: () => n.e(9839).then(n.bind(n, 9839)) },
          { id: 'dotenv', name: 'dotEnv', import: () => n.e(2665).then(n.bind(n, 2665)) },
          { id: 'dream-maker', name: 'Dream Maker', import: () => n.e(7717).then(n.bind(n, 7717)) },
          {
            id: 'edge',
            name: 'Edge',
            import: () => Promise.all([n.e(1950), n.e(5215), n.e(1874), n.e(5572), n.e(3916)]).then(n.bind(n, 3916)),
          },
          {
            id: 'elixir',
            name: 'Elixir',
            import: () => Promise.all([n.e(1950), n.e(1874), n.e(5572), n.e(1782)]).then(n.bind(n, 1782)),
          },
          { id: 'elm', name: 'Elm', import: () => Promise.all([n.e(5208), n.e(6799)]).then(n.bind(n, 6799)) },
          { id: 'emacs-lisp', name: 'Emacs Lisp', aliases: ['elisp'], import: () => n.e(3381).then(n.bind(n, 9361)) },
          {
            id: 'erb',
            name: 'ERB',
            import: () =>
          ...
          },
          {
            ...
            name: 'Erlang',
            aliases: ['erl'],
            import: () => Promise.all([n.e(4560), n.e(9450)]).then(n.bind(n, 9450)),
          },
          { id: 'fennel', name: 'Fennel', import: () => n.e(3615).then(n.bind(n, 3615)) },
          { id: 'fish', name: 'Fish', import: () => n.e(7873).then(n.bind(n, 7873)) },
          { id: 'fluent', name: 'Fluent', aliases: ['ftl'], import: () => n.e(977).then(n.bind(n, 977)) },
          {
            id: 'fortran-fixed-form',
            name: 'Fortran (Fixed Form)',
            aliases: ['f', 'for', 'f77'],
            import: () => Promise.all([n.e(7111), n.e(5345)]).then(n.bind(n, 5345)),
          },
          {
            id: 'fortran-free-form',
            name: 'Fortran (Free Form)',
            aliases: ['f90', 'f95', 'f03', 'f08', 'f18'],
            import: () => n.e(7111).then(n.bind(n, 7111)),
          },
          {
            id: 'fsharp',
            name: 'F#',
            aliases: ['f#', 'fs'],
            import: () => Promise.all([n.e(4560), n.e(8633)]).then(n.bind(n, 8633)),
          },
          { id: 'gdresource', name: 'GDResource', import: () => n.e(18).then(n.bind(n, 18)) },
          { id: 'gdscript', name: 'GDScript', import: () => n.e(4047).then(n.bind(n, 4047)) },
          { id: 'gdshader', name: 'GDShader', import: () => n.e(8221).then(n.bind(n, 8221)) },
          { id: 'genie', name: 'Genie', import: () => n.e(3359).then(n.bind(n, 3359)) },
          { id: 'gherkin', name: 'Gherkin', import: () => n.e(221).then(n.bind(n, 221)) },
          { id: 'git-commit', name: 'Git Commit Message', import: () => n.e(5365).then(n.bind(n, 5365)) },
          {
            id: 'git-rebase',
            name: 'Git Rebase Message',
            import: () => Promise.all([n.e(4248), n.e(2862)]).then(n.bind(n, 2862)),
          },
          { id: 'gleam', name: 'Gleam', import: () => n.e(1039).then(n.bind(n, 1039)) },
          {
            id: 'glimmer-js',
            name: 'Glimmer JS',
            aliases: ['gjs'],
            import: () => Promise.all([n.e(1950), n.e(5215), n.e(1874), n.e(5572), n.e(5984)]).then(n.bind(n, 5984)),
          },
          {
            id: 'glimmer-ts',
            name: 'Glimmer TS',
            aliases: ['gts'],
            import: () => Promise.all([n.e(1950), n.e(5215), n.e(1874), n.e(5572), n.e(7302)]).then(n.bind(n, 7302)),
          },
          { id: 'glsl', name: 'GLSL', import: () => Promise.all([n.e(5208), n.e(5607)]).then(n.bind(n, 5607)) },
          { id: 'gnuplot', name: 'Gnuplot', import: () => n.e(2766).then(n.bind(n, 2766)) },
          { id: 'go', name: 'Go', import: () => n.e(7821).then(n.bind(n, 7821)) },
          {
            id: 'graphql',
            name: 'GraphQL',
            aliases: ['gql'],
            import: () => Promise.all([n.e(1950), n.e(5215), n.e(5419), n.e(845), n.e(2840)]).then(n.bind(n, 2840)),
          },
          { id: 'groovy', name: 'Groovy', import: () => n.e(6273).then(n.bind(n, 6273)) },
          {
            id: 'hack',
            name: 'Hack',
            import: () => Promise.all([n.e(1950), n.e(1874), n.e(5572), n.e(1647), n.e(3440)]).then(n.bind(n, 3440)),
          },
          {
            id: 'haml',
            name: 'Ruby Haml',
            import: () => Promise.all([n.e(1950), n.e(1874), n.e(6105)]).then(n.bind(n, 6105)),
          },
          {
            id: 'handlebars',
            name: 'Handlebars',
            aliases: ['hbs'],
            import: () => Promise.all([n.e(1950), n.e(1874), n.e(5572), n.e(1671)]).then(n.bind(n, 1671)),
          },
          { id: 'haskell', name: 'Haskell', aliases: ['hs'], import: () => n.e(4687).then(n.bind(n, 4687)) },
          { id: 'haxe', name: 'Haxe', import: () => n.e(8604).then(n.bind(n, 8604)) },
          { id: 'hcl', name: 'HashiCorp HCL', import: () => n.e(2666).then(n.bind(n, 2666)) },
          { id: 'hjson', name: 'Hjson', import: () => n.e(5473).then(n.bind(n, 5473)) },
          { id: 'hlsl', name: 'HLSL', import: () => n.e(4774).then(n.bind(n, 4774)) },
          {
            id: 'html',
            name: 'HTML',
            import: () => Promise.all([n.e(1950), n.e(1874), n.e(5572)]).then(n.bind(n, 5572)),
          },
          {
            id: 'html-derivative',
            name: 'HTML (Derivative)',
            import: () => Promise.all([n.e(1950), n.e(1874), n.e(5572), n.e(6384)]).then(n.bind(n, 6384)),
          },
          {
            id: 'http',
            name: 'HTTP',
            import: () =>
              Promise.all([n.e(1950), n.e(5215), n.e(5419), n.e(845), n.e(5771), n.e(4248), n.e(2840), n.e(7875)]).then(
                n.bind(n, 7875)
              ),
          },
          { id: 'hxml', name: 'HXML', import: () => n.e(9544).then(n.bind(n, 9544)) },
          { id: 'hy', name: 'Hy', import: () => n.e(2294).then(n.bind(n, 2294)) },
          { id: 'imba', name: 'Imba', import: () => n.e(9294).then(n.bind(n, 9294)) },
          { id: 'ini', name: 'INI', aliases: ['properties'], import: () => n.e(9409).then(n.bind(n, 9409)) },
          { id: 'java', name: 'Java', import: () => n.e(5771).then(n.bind(n, 5771)) },
          { id: 'javascript', name: 'JavaScript', aliases: ['js'], import: () => n.e(1950).then(n.bind(n, 5094)) },
          {
            id: 'jinja',
            name: 'Jinja',
            import: () => Promise.all([n.e(1950), n.e(1874), n.e(5572), n.e(4509)]).then(n.bind(n, 4509)),
          },
          { id: 'jison', name: 'Jison', import: () => Promise.all([n.e(1950), n.e(3110)]).then(n.bind(n, 3110)) },
          { id: 'json', name: 'JSON', import: () => n.e(8481).then(n.bind(n, 8481)) },
          { id: 'json5', name: 'JSON5', import: () => n.e(1020).then(n.bind(n, 1020)) },
          { id: 'jsonc', name: 'JSON with Comments', import: () => n.e(3966).then(n.bind(n, 3966)) },
          { id: 'jsonl', name: 'JSON Lines', import: () => n.e(8121).then(n.bind(n, 8121)) },
          { id: 'jsonnet', name: 'Jsonnet', import: () => n.e(7644).then(n.bind(n, 7644)) },
          { id: 'jssm', name: 'JSSM', aliases: ['fsl'], import: () => n.e(6990).then(n.bind(n, 6990)) },
          { id: 'jsx', name: 'JSX', import: () => n.e(845).then(n.bind(n, 9324)) },
          {
            id: 'julia',
            name: 'Julia',
            aliases: ['jl'],
            import: () =>
              Promise.all([n.e(1950), n.e(3851), n.e(5076), n.e(1647), n.e(5208), n.e(7601), n.e(3309), n.e(753)]).then(
                n.bind(n, 6608)
              ),
          },
          { id: 'kotlin', name: 'Kotlin', aliases: ['kt', 'kts'], import: () => n.e(6628).then(n.bind(n, 6628)) },
          { id: 'kusto', name: 'Kusto', aliases: ['kql'], import: () => n.e(975).then(n.bind(n, 975)) },
          { id: 'latex', name: 'LaTeX', import: () => Promise.all([n.e(3309), n.e(3791)]).then(n.bind(n, 3791)) },
          { id: 'lean', name: 'Lean 4', aliases: ['lean4'], import: () => n.e(9107).then(n.bind(n, 9107)) },
          { id: 'less', name: 'Less', import: () => n.e(2192).then(n.bind(n, 2192)) },
          {
            id: 'liquid',
            name: 'Liquid',
            import: () => Promise.all([n.e(1950), n.e(1874), n.e(5572), n.e(363)]).then(n.bind(n, 363)),
          },
          { id: 'llvm', name: 'LLVM IR', import: () => n.e(1756).then(n.bind(n, 1756)) },
          { id: 'log', name: 'Log file', import: () => n.e(6465).then(n.bind(n, 6465)) },
          { id: 'logo', name: 'Logo', import: () => n.e(314).then(n.bind(n, 314)) },
          { id: 'lua', name: 'Lua', import: () => Promise.all([n.e(5208), n.e(701)]).then(n.bind(n, 701)) },
          { id: 'luau', name: 'Luau', import: () => n.e(4984).then(n.bind(n, 4984)) },
          { id: 'make', name: 'Makefile', aliases: ['makefile'], import: () => n.e(4985).then(n.bind(n, 4985)) },
          { id: 'markdown', name: 'Markdown', aliases: ['md'], import: () => n.e(4560).then(n.bind(n, 4560)) },
          {
            id: 'marko',
            name: 'Marko',
            import: () => Promise.all([n.e(5215), n.e(1874), n.e(3583), n.e(2192), n.e(7681)]).then(n.bind(n, 7681)),
          },
          { id: 'matlab', name: 'MATLAB', import: () => n.e(6408).then(n.bind(n, 6408)) },
          {
            id: 'mdc',
            name: 'MDC',
            import: () => Promise.all([n.e(1950), n.e(1874), n.e(5572), n.e(4560), n.e(8837)]).then(n.bind(n, 8837)),
          },
          { id: 'mdx', name: 'MDX', import: () => n.e(3278).then(n.bind(n, 3278)) },
          { id: 'mermaid', name: 'Mermaid', aliases: ['mmd'], import: () => n.e(6550).then(n.bind(n, 6550)) },
          { id: 'mipsasm', name: 'MIPS Assembly', aliases: ['mips'], import: () => n.e(705).then(n.bind(n, 705)) },
          { id: 'mojo', name: 'Mojo', import: () => n.e(6982).then(n.bind(n, 6982)) },
          { id: 'move', name: 'Move', import: () => n.e(2980).then(n.bind(n, 2980)) },
          { id: 'narrat', name: 'Narrat Language', aliases: ['nar'], import: () => n.e(7231).then(n.bind(n, 7231)) },
          { id: 'nextflow', name: 'Nextflow', aliases: ['nf'], import: () => n.e(7296).then(n.bind(n, 7296)) },
          { id: 'nginx', name: 'Nginx', import: () => Promise.all([n.e(5208), n.e(2303)]).then(n.bind(n, 4684)) },
          {
            id: 'nim',
            name: 'Nim',
            import: () =>
              Promise.all([n.e(1950), n.e(1874), n.e(5572), n.e(5771), n.e(5208), n.e(4560), n.e(8375)]).then(
                n.bind(n, 8375)
              ),
          },
          { id: 'nix', name: 'Nix', import: () => n.e(198).then(n.bind(n, 198)) },
          { id: 'nushell', name: 'nushell', aliases: ['nu'], import: () => n.e(6208).then(n.bind(n, 6208)) },
          { id: 'objective-c', name: 'Objective-C', aliases: ['objc'], import: () => n.e(6182).then(n.bind(n, 6182)) },
          { id: 'objective-cpp', name: 'Objective-C++', import: () => n.e(6183).then(n.bind(n, 6478)) },
          { id: 'ocaml', name: 'OCaml', import: () => n.e(379).then(n.bind(n, 379)) },
          { id: 'pascal', name: 'Pascal', import: () => n.e(8295).then(n.bind(n, 8295)) },
          {
            id: 'perl',
            name: 'Perl',
            import: () =>
              Promise.all([n.e(1950), n.e(1874), n.e(5572), n.e(5771), n.e(1647), n.e(8984)]).then(n.bind(n, 8984)),
          },
          {
            id: 'php',
            name: 'PHP',
            import: () =>
              Promise.all([n.e(1950), n.e(1874), n.e(5572), n.e(5771), n.e(1647), n.e(1347), n.e(9976)]).then(
                n.bind(n, 1347)
              ),
          },
          { id: 'plsql', name: 'PL/SQL', import: () => n.e(7595).then(n.bind(n, 7595)) },
          { id: 'po', name: 'Gettext PO', aliases: ['pot', 'potx'], import: () => n.e(204).then(n.bind(n, 204)) },
          { id: 'polar', name: 'Polar', import: () => n.e(9031).then(n.bind(n, 9031)) },
          { id: 'postcss', name: 'PostCSS', import: () => n.e(3056).then(n.bind(n, 3056)) },
          { id: 'powerquery', name: 'PowerQuery', import: () => n.e(2442).then(n.bind(n, 2442)) },
          {
            id: 'powershell',
            name: 'PowerShell',
            aliases: ['ps', 'ps1'],
            import: () => n.e(6540).then(n.bind(n, 6540)),
          },
          { id: 'prisma', name: 'Prisma', import: () => n.e(8407).then(n.bind(n, 8407)) },
          { id: 'prolog', name: 'Prolog', import: () => n.e(2958).then(n.bind(n, 2958)) },
          {
            id: 'proto',
            name: 'Protocol Buffer 3',
            aliases: ['protobuf'],
            import: () => n.e(5973).then(n.bind(n, 5973)),
          },
          {
            id: 'pug',
            name: 'Pug',
            aliases: ['jade'],
            import: () => Promise.all([n.e(1950), n.e(1874), n.e(5572), n.e(2163)]).then(n.bind(n, 2163)),
          },
          { id: 'puppet', name: 'Puppet', import: () => n.e(7101).then(n.bind(n, 7101)) },
          { id: 'purescript', name: 'PureScript', import: () => n.e(1652).then(n.bind(n, 1652)) },
          { id: 'python', name: 'Python', aliases: ['py'], import: () => n.e(7601).then(n.bind(n, 7601)) },
          { id: 'qml', name: 'QML', import: () => Promise.all([n.e(1950), n.e(4761)]).then(n.bind(n, 4761)) },
          { id: 'qmldir', name: 'QML Directory', import: () => n.e(8952).then(n.bind(n, 8952)) },
          { id: 'qss', name: 'Qt Style Sheets', import: () => n.e(2632).then(n.bind(n, 2632)) },
          { id: 'r', name: 'R', import: () => n.e(3309).then(n.bind(n, 3309)) },
          { id: 'racket', name: 'Racket', import: () => n.e(8265).then(n.bind(n, 8265)) },
          { id: 'raku', name: 'Raku', aliases: ['perl6'], import: () => n.e(6508).then(n.bind(n, 6508)) },
          {
            id: 'razor',
            name: 'ASP.NET Razor',
            import: () => Promise.all([n.e(1950), n.e(1874), n.e(5572), n.e(5545), n.e(5967)]).then(n.bind(n, 5967)),
          },
          { id: 'reg', name: 'Windows Registry Script', import: () => n.e(6817).then(n.bind(n, 6817)) },
          { id: 'regexp', name: 'RegExp', aliases: ['regex'], import: () => n.e(4796).then(n.bind(n, 4796)) },
          { id: 'rel', name: 'Rel', import: () => n.e(7498).then(n.bind(n, 7498)) },
          { id: 'riscv', name: 'RISC-V', import: () => n.e(7418).then(n.bind(n, 7418)) },
          {
            id: 'rst',
          ...
          { id: 'rust', name: 'Rust', aliases: ['rs'], import: () => n.e(7309).then(n.bind(n, 7309)) },
          { id: 'sas', name: 'SAS', import: () => Promise.all([n.e(1647), n.e(6624)]).then(n.bind(n, 6624)) },
          { id: 'sass', name: 'Sass', import: () => n.e(3557).then(n.bind(n, 5938)) },
          { id: 'scala', name: 'Scala', import: () => n.e(9125).then(n.bind(n, 9125)) },
          { id: 'scheme', name: 'Scheme', import: () => n.e(194).then(n.bind(n, 194)) },
          { id: 'scss', name: 'SCSS', import: () => Promise.all([n.e(1874), n.e(3583)]).then(n.bind(n, 3583)) },
          { id: 'sdbl', name: '1C (Query)', aliases: ['1c-query'], import: () => n.e(4048).then(n.bind(n, 4048)) },
          { id: 'shaderlab', name: 'ShaderLab', aliases: ['shader'], import: () => n.e(9267).then(n.bind(n, 9267)) },
          {
            id: 'shellscript',
            name: 'Shell',
            aliases: ['bash', 'sh', 'shell', 'zsh'],
            import: () => n.e(4248).then(n.bind(n, 4248)),
          },
          {
            id: 'shellsession',
            name: 'Shell Session',
            aliases: ['console'],
            import: () => Promise.all([n.e(4248), n.e(2565)]).then(n.bind(n, 2565)),
          },
          { id: 'smalltalk', name: 'Smalltalk', import: () => n.e(5644).then(n.bind(n, 5644)) },
          { id: 'solidity', name: 'Solidity', import: () => n.e(1616).then(n.bind(n, 1616)) },
          {
            id: 'soy',
            name: 'Closure Templates',
            aliases: ['closure-templates'],
            import: () => Promise.all([n.e(1950), n.e(1874), n.e(5572), n.e(2392)]).then(n.bind(n, 2392)),
          },
          { id: 'sparql', name: 'SPARQL', import: () => n.e(5144).then(n.bind(n, 5144)) },
          {
            id: 'splunk',
            name: 'Splunk Query Language',
            aliases: ['spl'],
            import: () => n.e(2846).then(n.bind(n, 2846)),
          },
          { id: 'sql', name: 'SQL', import: () => n.e(1647).then(n.bind(n, 1647)) },
          { id: 'ssh-config', name: 'SSH Config', import: () => n.e(2282).then(n.bind(n, 2282)) },
          { id: 'stata', name: 'Stata', import: () => Promise.all([n.e(1647), n.e(2584)]).then(n.bind(n, 2584)) },
          { id: 'stylus', name: 'Stylus', aliases: ['styl'], import: () => n.e(9017).then(n.bind(n, 9017)) },
          {
            id: 'svelte',
            name: 'Svelte',
            import: () => Promise.all([n.e(1950), n.e(5215), n.e(1874), n.e(1202)]).then(n.bind(n, 1202)),
          },
          { id: 'swift', name: 'Swift', import: () => n.e(926).then(n.bind(n, 926)) },
          { id: 'system-verilog', name: 'SystemVerilog', import: () => n.e(7105).then(n.bind(n, 7105)) },
          { id: 'systemd', name: 'Systemd Units', import: () => n.e(9354).then(n.bind(n, 9354)) },
          { id: 'talonscript', name: 'TalonScript', aliases: ['talon'], import: () => n.e(5882).then(n.bind(n, 5882)) },
          { id: 'tasl', name: 'Tasl', import: () => n.e(3891).then(n.bind(n, 3891)) },
          { id: 'tcl', name: 'Tcl', import: () => n.e(9118).then(n.bind(n, 9118)) },
          {
            id: 'templ',
            name: 'Templ',
            import: () => Promise.all([n.e(1950), n.e(1874), n.e(7821), n.e(4629)]).then(n.bind(n, 4629)),
          },
          {
            id: 'terraform',
            name: 'Terraform',
            aliases: ['tf', 'tfvars'],
            import: () => n.e(8875).then(n.bind(n, 8875)),
          },
          { id: 'tex', name: 'TeX', import: () => Promise.all([n.e(3309), n.e(7288)]).then(n.bind(n, 7288)) },
          { id: 'toml', name: 'TOML', import: () => n.e(9827).then(n.bind(n, 9827)) },
          {
            id: 'ts-tags',
          ...
          { id: 'tsv', name: 'TSV', import: () => n.e(6144).then(n.bind(n, 6144)) },
          { id: 'tsx', name: 'TSX', import: () => n.e(5419).then(n.bind(n, 3986)) },
          { id: 'turtle', name: 'Turtle', import: () => n.e(9417).then(n.bind(n, 9417)) },
          {
            id: 'twig',
            name: 'Twig',
            import: () =>
          ...
          { id: 'typescript', name: 'TypeScript', aliases: ['ts'], import: () => n.e(5215).then(n.bind(n, 8406)) },
          { id: 'typespec', name: 'TypeSpec', aliases: ['tsp'], import: () => n.e(7310).then(n.bind(n, 7310)) },
          { id: 'typst', name: 'Typst', aliases: ['typ'], import: () => n.e(9713).then(n.bind(n, 9713)) },
          { id: 'v', name: 'V', import: () => n.e(4225).then(n.bind(n, 4225)) },
          { id: 'vala', name: 'Vala', import: () => n.e(8201).then(n.bind(n, 8201)) },
          { id: 'vb', name: 'Visual Basic', aliases: ['cmd'], import: () => n.e(6043).then(n.bind(n, 6043)) },
          { id: 'verilog', name: 'Verilog', import: () => n.e(7541).then(n.bind(n, 7541)) },
          { id: 'vhdl', name: 'VHDL', import: () => n.e(7181).then(n.bind(n, 7181)) },
          {
            id: 'viml',
            name: 'Vim Script',
            aliases: ['vim', 'vimscript'],
            import: () => n.e(2467).then(n.bind(n, 2467)),
          },
          {
            id: 'vue',
            name: 'Vue',
            import: () => Promise.all([n.e(1950), n.e(5215), n.e(1874), n.e(5572), n.e(2431)]).then(n.bind(n, 2431)),
          },
          {
            id: 'vue-html',
            name: 'Vue HTML',
            import: () =>
              Promise.all([n.e(1950), n.e(5215), n.e(1874), n.e(5572), n.e(2431), n.e(5985)]).then(n.bind(n, 5985)),
          },
          {
            id: 'vue-vine',
            name: 'Vue Vine',
          ...
          { id: 'vyper', name: 'Vyper', aliases: ['vy'], import: () => n.e(587).then(n.bind(n, 587)) },
          { id: 'wasm', name: 'WebAssembly', import: () => n.e(8419).then(n.bind(n, 8419)) },
          { id: 'wenyan', name: 'Wenyan', aliases: ['文言'], import: () => n.e(9841).then(n.bind(n, 9841)) },
          { id: 'wgsl', name: 'WGSL', import: () => n.e(9992).then(n.bind(n, 9992)) },
          {
            id: 'wikitext',
            name: 'Wikitext',
          ...
          { id: 'wit', name: 'WebAssembly Interface Types', import: () => n.e(3307).then(n.bind(n, 3307)) },
          { id: 'wolfram', name: 'Wolfram', aliases: ['wl'], import: () => n.e(7370).then(n.bind(n, 2363)) },
          { id: 'xml', name: 'XML', import: () => Promise.all([n.e(5771), n.e(5214)]).then(n.bind(n, 9976)) },
          { id: 'xsl', name: 'XSL', import: () => Promise.all([n.e(5771), n.e(8442)]).then(n.bind(n, 8442)) },
          { id: 'yaml', name: 'YAML', aliases: ['yml'], import: () => n.e(2882).then(n.bind(n, 2882)) },
          { id: 'zenscript', name: 'ZenScript', import: () => n.e(1345).then(n.bind(n, 1345)) },
          { id: 'zig', name: 'Zig', import: () => n.e(1029).then(n.bind(n, 1029)) },
        ],
        ...
        nd = Object.fromEntries(
          [
            { id: 'andromeeda', displayName: 'Andromeeda', type: 'dark', import: () => n.e(767).then(n.bind(n, 767)) },
            { id: 'aurora-x', displayName: 'Aurora X', type: 'dark', import: () => n.e(9948).then(n.bind(n, 9948)) },
            { id: 'ayu-dark', displayName: 'Ayu Dark', type: 'dark', import: () => n.e(9383).then(n.bind(n, 9383)) },
            {
              id: 'catppuccin-frappe',
              displayName: 'Catppuccin Frapp\xe9',
              type: 'dark',
              import: () => n.e(3118).then(n.bind(n, 3118)),
            },
            {
              id: 'catppuccin-latte',
              displayName: 'Catppuccin Latte',
              type: 'light',
              import: () => n.e(9492).then(n.bind(n, 9492)),
            },
            {
              id: 'catppuccin-macchiato',
              displayName: 'Catppuccin Macchiato',
              type: 'dark',
              import: () => n.e(9139).then(n.bind(n, 9139)),
            },
            {
              id: 'catppuccin-mocha',
            ...
            { id: 'dark-plus', displayName: 'Dark Plus', type: 'dark', import: () => n.e(1734).then(n.bind(n, 1734)) },
            { id: 'dracula', displayName: 'Dracula Theme', type: 'dark', import: () => n.e(21).then(n.bind(n, 21)) },
            {
              id: 'dracula-soft',
              displayName: 'Dracula Theme Soft',
              type: 'dark',
              import: () => n.e(8824).then(n.bind(n, 8824)),
            },
            {
              id: 'everforest-dark',
              displayName: 'Everforest Dark',
              type: 'dark',
              import: () => n.e(3975).then(n.bind(n, 3975)),
            },
            {
              id: 'everforest-light',
              displayName: 'Everforest Light',
              type: 'light',
              import: () => n.e(551).then(n.bind(n, 551)),
            },
            {
              id: 'github-dark',
              displayName: 'GitHub Dark',
              type: 'dark',
              import: () => n.e(7797).then(n.bind(n, 7797)),
            },
            {
              id: 'github-dark-default',
              displayName: 'GitHub Dark Default',
              type: 'dark',
              import: () => n.e(7321).then(n.bind(n, 7321)),
            },
            {
              id: 'github-dark-dimmed',
              displayName: 'GitHub Dark Dimmed',
              type: 'dark',
              import: () => n.e(784).then(n.bind(n, 784)),
            },
            {
              id: 'github-dark-high-contrast',
              displayName: 'GitHub Dark High Contrast',
              type: 'dark',
              import: () => n.e(8509).then(n.bind(n, 8509)),
            },
            {
              id: 'github-light',
              displayName: 'GitHub Light',
              type: 'light',
              import: () => n.e(4805).then(n.bind(n, 4805)),
            },
            {
              id: 'github-light-default',
              displayName: 'GitHub Light Default',
              type: 'light',
              import: () => n.e(8713).then(n.bind(n, 8713)),
            },
            {
              id: 'github-light-high-contrast',
              displayName: 'GitHub Light High Contrast',
              type: 'light',
              import: () => n.e(5181).then(n.bind(n, 5181)),
            },
            {
              id: 'gruvbox-dark-hard',
              displayName: 'Gruvbox Dark Hard',
              type: 'dark',
              import: () => n.e(5547).then(n.bind(n, 5547)),
            },
            {
              id: 'gruvbox-dark-medium',
              displayName: 'Gruvbox Dark Medium',
              type: 'dark',
              import: () => n.e(4401).then(n.bind(n, 4401)),
            },
            {
              id: 'gruvbox-dark-soft',
              displayName: 'Gruvbox Dark Soft',
              type: 'dark',
              import: () => n.e(8536).then(n.bind(n, 8536)),
            },
            {
              id: 'gruvbox-light-hard',
              displayName: 'Gruvbox Light Hard',
              type: 'light',
              import: () => n.e(8699).then(n.bind(n, 8699)),
            },
            {
              id: 'gruvbox-light-medium',
              displayName: 'Gruvbox Light Medium',
              type: 'light',
              import: () => n.e(2049).then(n.bind(n, 2049)),
            },
            {
              id: 'gruvbox-light-soft',
              displayName: 'Gruvbox Light Soft',
              type: 'light',
              import: () => n.e(2760).then(n.bind(n, 2760)),
            },
            { id: 'houston', displayName: 'Houston', type: 'dark', import: () => n.e(2333).then(n.bind(n, 2333)) },
            {
              id: 'kanagawa-dragon',
              displayName: 'Kanagawa Dragon',
              type: 'dark',
              import: () => n.e(6574).then(n.bind(n, 6574)),
            },
            {
              id: 'kanagawa-lotus',
              displayName: 'Kanagawa Lotus',
              type: 'light',
              import: () => n.e(2802).then(n.bind(n, 2802)),
            },
            {
              id: 'kanagawa-wave',
              displayName: 'Kanagawa Wave',
              type: 'dark',
              import: () => n.e(7424).then(n.bind(n, 7424)),
            },
            { id: 'laserwave', displayName: 'LaserWave', type: 'dark', import: () => n.e(3549).then(n.bind(n, 3549)) },
            {
              id: 'light-plus',
              displayName: 'Light Plus',
              type: 'light',
              import: () => n.e(4158).then(n.bind(n, 4158)),
            },
            {
              id: 'material-theme',
            ...
            },
            {
              ...
              type: 'dark',
              import: () => n.e(4326).then(n.bind(n, 4326)),
            },
            {
              id: 'material-theme-lighter',
              displayName: 'Material Theme Lighter',
              type: 'light',
              import: () => n.e(2566).then(n.bind(n, 2566)),
            },
            {
              id: 'material-theme-ocean',
              displayName: 'Material Theme Ocean',
              type: 'dark',
              import: () => n.e(1541).then(n.bind(n, 1541)),
            },
            {
              id: 'material-theme-palenight',
              displayName: 'Material Theme Palenight',
              type: 'dark',
              import: () => n.e(1317).then(n.bind(n, 1317)),
            },
            { id: 'min-dark', displayName: 'Min Dark', type: 'dark', import: () => n.e(5058).then(n.bind(n, 5058)) },
            { id: 'min-light', displayName: 'Min Light', type: 'light', import: () => n.e(8176).then(n.bind(n, 8176)) },
            { id: 'monokai', displayName: 'Monokai', type: 'dark', import: () => n.e(6445).then(n.bind(n, 6445)) },
            { id: 'night-owl', displayName: 'Night Owl', type: 'dark', import: () => n.e(6516).then(n.bind(n, 6516)) },
            { id: 'nord', displayName: 'Nord', type: 'dark', import: () => n.e(5900).then(n.bind(n, 5900)) },
            {
              id: 'one-dark-pro',
              displayName: 'One Dark Pro',
              type: 'dark',
              import: () => n.e(7548).then(n.bind(n, 7548)),
            },
            { id: 'one-light', displayName: 'One Light', type: 'light', import: () => n.e(2360).then(n.bind(n, 2360)) },
            { id: 'plastic', displayName: 'Plastic', type: 'dark', import: () => n.e(4919).then(n.bind(n, 4919)) },
            {
              id: 'poimandres',
              displayName: 'Poimandres',
              type: 'dark',
              import: () => n.e(5021).then(n.bind(n, 5021)),
            },
            { id: 'red', displayName: 'Red', type: 'dark', import: () => n.e(2646).then(n.bind(n, 2646)) },
            {
              id: 'rose-pine',
              displayName: 'Ros\xe9 Pine',
              type: 'dark',
              import: () => n.e(9487).then(n.bind(n, 9487)),
            },
            {
              id: 'rose-pine-dawn',
              displayName: 'Ros\xe9 Pine Dawn',
              type: 'light',
              import: () => n.e(1948).then(n.bind(n, 1948)),
            },
            {
              id: 'rose-pine-moon',
              displayName: 'Ros\xe9 Pine Moon',
              type: 'dark',
              import: () => n.e(8118).then(n.bind(n, 8118)),
            },
            {
              id: 'slack-dark',
              displayName: 'Slack Dark',
              type: 'dark',
              import: () => n.e(1790).then(n.bind(n, 1790)),
            },
            {
              id: 'slack-ochin',
              displayName: 'Slack Ochin',
              type: 'light',
              import: () => n.e(4983).then(n.bind(n, 4983)),
            },
            {
              id: 'snazzy-light',
              displayName: 'Snazzy Light',
              type: 'light',
              import: () => n.e(9273).then(n.bind(n, 9273)),
            },
            {
              id: 'solarized-dark',
            ...
            },
            {
              ...
              type: 'light',
              import: () => n.e(709).then(n.bind(n, 709)),
            },
            {
              id: 'synthwave-84',
              displayName: "Synthwave '84",
              type: 'dark',
              import: () => n.e(3733).then(n.bind(n, 3733)),
            },
            {
              id: 'tokyo-night',
              displayName: 'Tokyo Night',
              type: 'dark',
              import: () => n.e(2352).then(n.bind(n, 2352)),
            },
            { id: 'vesper', displayName: 'Vesper', type: 'dark', import: () => n.e(9044).then(n.bind(n, 9044)) },
            {
              id: 'vitesse-black',
              displayName: 'Vitesse Black',
              type: 'dark',
              import: () => n.e(240).then(n.bind(n, 240)),
            },
            {
              id: 'vitesse-dark',
              displayName: 'Vitesse Dark',
              type: 'dark',
              import: () => n.e(1209).then(n.bind(n, 1209)),
            },
            {
              id: 'vitesse-light',
              displayName: 'Vitesse Light',
              type: 'light',
              import: () => n.e(4049).then(n.bind(n, 4049)),
            },
          ].map((e) => [e.id, e.import])
        );
      var np = n(8756).Buffer;
      ...
      var nb = Object.defineProperty,
        n_ = (e, t, n) =>
          ((e, t, n) => (t in e ? nb(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n }) : (e[t] = n)))(
            e,
            'symbol' != typeof t ? t + '' : t,
            n
          );
      ...
      class nk {
        constructor(e) {
          (n_(this, 'utf16Length'),
            ...
            n_(this, 'utf16Value'),
            n_(this, 'utf8Value'),
            n_(this, 'utf16OffsetToUtf8'),
            n_(this, 'utf8OffsetToUtf16'));
          let t = e.length,
            n = nk._utf8ByteLength(e),
            r = n !== t,
      ...
      let nw = class e {
        constructor(t) {
          if (
            (n_(this, 'id', ++e.LAST_ID),
            n_(this, '_onigBinding'),
            n_(this, 'content'),
            n_(this, 'utf16Length'),
            n_(this, 'utf8Length'),
            n_(this, 'utf16OffsetToUtf8'),
          ...
          ((this._onigBinding = nv), (this.content = t));
          let n = new nk(t);
          ((this.utf16Length = n.utf16Length),
            ...
            this.utf8Length < 1e4 && !e._sharedPtrInUse
              ? (e._sharedPtr || (e._sharedPtr = nv.omalloc(1e4)),
                (e._sharedPtrInUse = !0),
                nv.HEAPU8.set(n.utf8Value, e._sharedPtr),
                (this.ptr = e._sharedPtr))
              : (this.ptr = n.createString(nv)));
        }
      ...
      (n_(nw, 'LAST_ID', 0), n_(nw, '_sharedPtr', 0), n_(nw, '_sharedPtrInUse', !1));
      class nS {
        constructor(e) {
          if ((n_(this, '_onigBinding'), n_(this, '_ptr'), !nv)) throw new nm('Must invoke loadWasm first.');
          let t = [],
            n = [];
          for (let r = 0, i = e.length; r < i; r++) {
            let i = new nk(e[r]);
            ((t[r] = i.createString(nv)), (n[r] = i.utf8Length));
          }
          let r = nv.omalloc(4 * e.length);
          nv.HEAPU32.set(t, r / 4);
          let i = nv.omalloc(4 * e.length);
          nv.HEAPU32.set(n, i / 4);
          let a = nv.createOnigScanner(r, i, e.length);
          for (let n = 0, r = e.length; n < r; n++) nv.ofree(t[n]);
          (nv.ofree(i),
            nv.ofree(r),
            0 === a &&
              (function (e) {
                  ...
                  if (
                    ...
                    if (
                      ...
                      ('undefined' != typeof ArrayBuffer && (i instanceof ArrayBuffer || ArrayBuffer.isView(i))) ||
                        ...
                        ? (n = await nC(n)(t))
                        : 'default' in n && n.default instanceof WebAssembly.Module && (n = await nC(n.default)(t));
                  }
                  return ('instance' in n && (n = n.instance), 'exports' in n && (n = n.exports), n);
                });
              })()))),
          {
            createScanner: (e) => new nS(e.map((e) => ('string' == typeof e ? e : e.source))),
            createString: (e) => new nw(e),
          }
        );
      }
      let { codeToHtml: nP } = (function (e, t) {
        let n,
          r = async function (t = {}) {
        ...
        })({ langs: nc, themes: nd, engine: () => nA(Promise.all([n.e(8223), n.e(755)]).then(n.bind(n, 755))) }),
        {
              ...
              ((s.isBuffer = function (e) {
                ...
                (s.concat = function (e, t) {
                  ...
                  for (n = 0; n < e.length; ++n) {
                    var a = e[n];
                    if ((L(a, Uint8Array) && (a = s.from(a)), !s.isBuffer(a)))
                ...
                (s.prototype.compare = function (e, t, n, r, i) {
                  if ((L(e, Uint8Array) && (e = s.from(e, e.offset, e.byteLength)), !s.isBuffer(e)))
                    throw TypeError(
